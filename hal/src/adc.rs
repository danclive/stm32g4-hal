...
impl Adc<pac::Adc1, Disabled> {
    ...
    pub fn enable_dma(mut self, dma: config::Dma) -> Adc<pac::Adc1, Enabled> {
    ...
    pub fn configure_channel<CHANNEL>(
        ...
        CHANNEL: Channel<pac::Adc1, ID = u8>,
    {
    ...
    #[inline(always)]
    fn enable_vbat(&self, common: &pac::Adc12Common) {
...
impl Adc<pac::Adc1, Enabled> {
    ...
    #[inline(always)]
    pub fn start_conversion(mut self) -> Adc<pac::Adc1, Active> {
        self.inner.clear_end_of_conversion_flag();
...
impl Adc<pac::Adc1, Active> {
    ...
    #[inline(always)]
    pub fn cancel_conversion(mut self) -> Adc<pac::Adc1, Enabled> {
        self.inner.cancel_conversion();
...
impl AdcInner<pac::Adc1> {
    /// Disables the Voltage Regulator and release the ADC
    #[inline(always)]
    fn release(mut self) -> pac::Adc1 {
