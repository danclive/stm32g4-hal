...
pub struct OutPortArray<const P: char, const SIZE: usize>(
    pub [PartiallyErasedPin<P, Output<PushPull>>; SIZE],
);

impl<const P: char, const SIZE: usize> OutPort for [PartiallyErasedPin<P, Output<PushPull>>; SIZE] {
