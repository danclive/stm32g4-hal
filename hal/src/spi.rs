...
impl SpiExt<pac::Spi1> for pac::Spi1 {
    fn spi<SCK, MISO, MOSI>(
        self,
        pins: (SCK, MISO, MOSI),
        mode: Mode,
        clocks: &Clocks,
        freq: impl Into<Hertz>,
    ) -> Spi<pac::Spi1, SCK, MISO, MOSI>
    where
        SCK: SCKPin<pac::Spi1>,
        MISO: MISOPin<pac::Spi1>,
        MOSI: MOSIPin<pac::Spi1>,
    {
        Spi::new(self, pins, mode, clocks, freq)
    }
    ...
    fn spi_bidi<SCK, MOSI>(
        ...
        clocks: &Clocks,
        freq: impl Into<Hertz>,
    ) -> Spi<pac::Spi1, SCK, NoMiso, MOSI, true>
    where
        SCK: SCKPin<pac::Spi1>,
        MOSI: MOSIPin<pac::Spi1>,
    {
        Spi::new(self, (pins.0, NoPin::new(), pins.1), mode, clocks, freq)
    }
    ...
    fn spi_slave<SCK, MISO, MOSI, NSS>(
        ...
        pins: (SCK, MISO, MOSI, Option<NSS>),
        mode: Mode,
    ) -> SpiSlave<pac::Spi1, SCK, MISO, MOSI, NSS>
    where
        SCK: SCKPin<pac::Spi1>,
        MISO: MISOPin<pac::Spi1>,
        MOSI: MOSIPin<pac::Spi1>,
    ...
    fn spi_slave_bidi<SCK, MISO, NSS>(
        ...
        pins: (SCK, MISO, Option<NSS>),
        mode: Mode,
    ) -> SpiSlave<pac::Spi1, SCK, MISO, NoMosi, NSS, true>
    where
        SCK: SCKPin<pac::Spi1>,
        MISO: MISOPin<pac::Spi1>,
        NSS: PinNss<pac::Spi1>,
    {
        SpiSlave::new(self, (pins.0, pins.1, NoPin::new(), pins.2), mode)
    }
}

impl<SCK, MISO, MOSI, const BIDI: bool> Spi<pac::Spi1, SCK, MISO, MOSI, BIDI>
where
    SCK: SCKPin<pac::Spi1>,
    MISO: MISOPin<pac::Spi1>,
    MOSI: MOSIPin<pac::Spi1>,
{
    pub fn new(
        ...
        unsafe {
            ...
            <pac::Spi1>::enable(rcc_ptr);
            <pac::Spi1>::reset(rcc_ptr);
        }
        ...
        let clk = <pac::Spi1>::timer_clock(clocks).raw();
    ...
    pub fn release(self) -> (pac::Spi1, (SCK, MISO, MOSI)) {
        unsafe {
            let rcc = &(*pac::Rcc::PTR);
            <pac::Spi1>::reset(rcc);
            <pac::Spi1>::disable(rcc);
        }
...
impl<SCK, MISO, MOSI, NSS, const BIDI: bool> SpiSlave<pac::Spi1, SCK, MISO, MOSI, NSS, BIDI>
where
    SCK: SCKPin<pac::Spi1>,
    MISO: MISOPin<pac::Spi1>,
    MOSI: MOSIPin<pac::Spi1>,
    NSS: PinNss<pac::Spi1>,
{
    pub fn new(spi: pac::Spi1, pins: (SCK, MISO, MOSI, Option<NSS>), mode: Mode) -> Self {
        unsafe {
            let rcc_ptr = &(*pac::Rcc::PTR);
            <pac::Spi1>::enable(rcc_ptr);
            <pac::Spi1>::reset(rcc_ptr);
    ...
    pub fn release(self) -> (pac::Spi1, (SCK, MISO, MOSI, Option<NSS>)) {
        unsafe {
            let rcc = &(*pac::Rcc::PTR);
            <pac::Spi1>::reset(rcc);
            <pac::Spi1>::disable(rcc);
...
impl<SCK, MISO, MOSI, const BIDI: bool> Deref for Spi<pac::Spi1, SCK, MISO, MOSI, BIDI> {
    type Target = Inner<pac::Spi1>;
...
impl<SCK, MISO, MOSI, const BIDI: bool> DerefMut for Spi<pac::Spi1, SCK, MISO, MOSI, BIDI> {
...
impl<SCK, MISO, MOSI, NSS, const BIDI: bool> Deref
    for SpiSlave<pac::Spi1, SCK, MISO, MOSI, NSS, BIDI>
{
    type Target = Inner<pac::Spi1>;
...
macro_rules! pin {
    ($SPIX:ident: {
        ...
        impl SCKPin<pac::$SPIX> for NoSck {}

        impl MISOPin<pac::$SPIX> for NoMiso {}

        impl MOSIPin<pac::$SPIX> for NoMosi {}

        impl PinNss<pac::$SPIX> for NoPin {}
