...
impl W {
    #[doc = "Bits 0:11 - OFFSET1"]
    #[inline(always)]
    pub fn offset1(&mut self) -> Offset1W<'_, Ofr2Spec> {
        Offset1W::new(self, 0)
    }
    #[doc = "Bit 24 - OFFSETPOS"]
    #[inline(always)]
    pub fn offsetpos(&mut self) -> OffsetposW<'_, Ofr2Spec> {
        OffsetposW::new(self, 24)
    }
    #[doc = "Bit 25 - SATEN"]
    #[inline(always)]
    pub fn saten(&mut self) -> SatenW<'_, Ofr2Spec> {
        SatenW::new(self, 25)
    }
    #[doc = "Bits 26:30 - OFFSET1_CH"]
    #[inline(always)]
    pub fn offset1_ch(&mut self) -> Offset1ChW<'_, Ofr2Spec> {
        Offset1ChW::new(self, 26)
    }
    #[doc = "Bit 31 - OFFSET1_EN"]
    #[inline(always)]
    pub fn offset1_en(&mut self) -> Offset1EnW<'_, Ofr2Spec> {
