...
pub type R = crate::R<Keyr6Spec>;
#[doc = "Register `KEYR6` writer"]
pub type W = crate::W<Keyr6Spec>;
...
impl W {
    #[doc = "Bits 0:31 - AES key"]
    #[inline(always)]
    pub fn key(&mut self) -> KeyW<'_, Keyr6Spec> {
        KeyW::new(self, 0)
    }
}
...
pub struct Keyr6Spec;
impl crate::RegisterSpec for Keyr6Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`keyr6::R`](R) reader structure"]
impl crate::Readable for Keyr6Spec {}
#[doc = "`write(|w| ..)` method takes [`keyr6::W`](W) writer structure"]
impl crate::Writable for Keyr6Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets KEYR6 to value 0"]
impl crate::Resettable for Keyr6Spec {}
