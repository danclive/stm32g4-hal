...
pub type R = crate::R<Keyr7Spec>;
#[doc = "Register `KEYR7` writer"]
pub type W = crate::W<Keyr7Spec>;
...
impl W {
    #[doc = "Bits 0:31 - AES key"]
    #[inline(always)]
    pub fn key(&mut self) -> KeyW<'_, Keyr7Spec> {
        KeyW::new(self, 0)
    }
}
...
pub struct Keyr7Spec;
impl crate::RegisterSpec for Keyr7Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`keyr7::R`](R) reader structure"]
impl crate::Readable for Keyr7Spec {}
#[doc = "`write(|w| ..)` method takes [`keyr7::W`](W) writer structure"]
impl crate::Writable for Keyr7Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets KEYR7 to value 0"]
impl crate::Resettable for Keyr7Spec {}
