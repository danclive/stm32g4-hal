...
pub type R = crate::R<CompC1csrSpec>;
#[doc = "Register `COMP_C1CSR` writer"]
pub type W = crate::W<CompC1csrSpec>;
...
impl W {
    #[doc = "Bit 0 - EN"]
    #[inline(always)]
    pub fn en(&mut self) -> EnW<'_, CompC1csrSpec> {
        EnW::new(self, 0)
    }
    #[doc = "Bits 4:6 - INMSEL"]
    #[inline(always)]
    pub fn inmsel(&mut self) -> InmselW<'_, CompC1csrSpec> {
        InmselW::new(self, 4)
    }
    #[doc = "Bit 8 - INPSEL"]
    #[inline(always)]
    pub fn inpsel(&mut self) -> InpselW<'_, CompC1csrSpec> {
        InpselW::new(self, 8)
    }
    #[doc = "Bit 15 - POL"]
    #[inline(always)]
    pub fn pol(&mut self) -> PolW<'_, CompC1csrSpec> {
        PolW::new(self, 15)
    }
    #[doc = "Bits 16:18 - HYST"]
    #[inline(always)]
    pub fn hyst(&mut self) -> HystW<'_, CompC1csrSpec> {
        HystW::new(self, 16)
    }
    #[doc = "Bits 19:21 - BLANKSEL"]
    #[inline(always)]
    pub fn blanksel(&mut self) -> BlankselW<'_, CompC1csrSpec> {
        BlankselW::new(self, 19)
    }
    #[doc = "Bit 22 - BRGEN"]
    #[inline(always)]
    pub fn brgen(&mut self) -> BrgenW<'_, CompC1csrSpec> {
        BrgenW::new(self, 22)
    }
    #[doc = "Bit 23 - SCALEN"]
    #[inline(always)]
    pub fn scalen(&mut self) -> ScalenW<'_, CompC1csrSpec> {
        ScalenW::new(self, 23)
    }
    #[doc = "Bit 31 - LOCK"]
    #[inline(always)]
    pub fn lock(&mut self) -> LockW<'_, CompC1csrSpec> {
        LockW::new(self, 31)
    }
}
#[doc = "Comparator control/status register\n\nYou can [`read`](crate::Reg::read) this register and get [`comp_c1csr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`comp_c1csr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct CompC1csrSpec;
impl crate::RegisterSpec for CompC1csrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`comp_c1csr::R`](R) reader structure"]
impl crate::Readable for CompC1csrSpec {}
#[doc = "`write(|w| ..)` method takes [`comp_c1csr::W`](W) writer structure"]
impl crate::Writable for CompC1csrSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets COMP_C1CSR to value 0"]
impl crate::Resettable for CompC1csrSpec {}
