...
pub type R = crate::R<CompC2csrSpec>;
#[doc = "Register `COMP_C2CSR` writer"]
pub type W = crate::W<CompC2csrSpec>;
...
impl W {
    #[doc = "Bit 0 - EN"]
    #[inline(always)]
    pub fn en(&mut self) -> EnW<'_, CompC2csrSpec> {
        EnW::new(self, 0)
    }
    #[doc = "Bits 4:6 - INMSEL"]
    #[inline(always)]
    pub fn inmsel(&mut self) -> InmselW<'_, CompC2csrSpec> {
        InmselW::new(self, 4)
    }
    #[doc = "Bit 8 - INPSEL"]
    #[inline(always)]
    pub fn inpsel(&mut self) -> InpselW<'_, CompC2csrSpec> {
        InpselW::new(self, 8)
    }
    #[doc = "Bit 15 - POL"]
    #[inline(always)]
    pub fn pol(&mut self) -> PolW<'_, CompC2csrSpec> {
        PolW::new(self, 15)
    }
    #[doc = "Bits 16:18 - HYST"]
    #[inline(always)]
    pub fn hyst(&mut self) -> HystW<'_, CompC2csrSpec> {
        HystW::new(self, 16)
    }
    #[doc = "Bits 19:21 - BLANKSEL"]
    #[inline(always)]
    pub fn blanksel(&mut self) -> BlankselW<'_, CompC2csrSpec> {
        BlankselW::new(self, 19)
    }
    #[doc = "Bit 22 - BRGEN"]
    #[inline(always)]
    pub fn brgen(&mut self) -> BrgenW<'_, CompC2csrSpec> {
        BrgenW::new(self, 22)
    }
    #[doc = "Bit 23 - SCALEN"]
    #[inline(always)]
    pub fn scalen(&mut self) -> ScalenW<'_, CompC2csrSpec> {
        ScalenW::new(self, 23)
    }
    #[doc = "Bit 31 - LOCK"]
    #[inline(always)]
    pub fn lock(&mut self) -> LockW<'_, CompC2csrSpec> {
        LockW::new(self, 31)
    }
}
#[doc = "Comparator control/status register\n\nYou can [`read`](crate::Reg::read) this register and get [`comp_c2csr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`comp_c2csr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct CompC2csrSpec;
impl crate::RegisterSpec for CompC2csrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`comp_c2csr::R`](R) reader structure"]
impl crate::Readable for CompC2csrSpec {}
#[doc = "`write(|w| ..)` method takes [`comp_c2csr::W`](W) writer structure"]
impl crate::Writable for CompC2csrSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets COMP_C2CSR to value 0"]
impl crate::Resettable for CompC2csrSpec {}
