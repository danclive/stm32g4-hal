...
pub type R = crate::R<CompC4csrSpec>;
#[doc = "Register `COMP_C4CSR` writer"]
pub type W = crate::W<CompC4csrSpec>;
...
#[doc = "Comparator control/status register\n\nYou can [`read`](crate::Reg::read) this register and get [`comp_c4csr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`comp_c4csr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct CompC4csrSpec;
impl crate::RegisterSpec for CompC4csrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`comp_c4csr::R`](R) reader structure"]
impl crate::Readable for CompC4csrSpec {}
