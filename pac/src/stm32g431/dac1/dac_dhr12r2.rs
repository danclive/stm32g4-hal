...
pub type R = crate::R<DacDhr12r2Spec>;
#[doc = "Register `DAC_DHR12R2` writer"]
pub type W = crate::W<DacDhr12r2Spec>;
...
impl R {
    ...
    pub fn dacc2dhrb(&self) -> Dacc2dhrbR {
        Dacc2dhrbR::new(((self.bits >> 16) & 0x0fff) as u16)
    }
}
...
impl W {
    #[doc = "Bits 0:11 - DAC channel2 12-bit right-aligned data These bits are written by software which specifies 12-bit data for DAC channel2."]
    #[inline(always)]
    pub fn dacc2dhr(&mut self) -> Dacc2dhrW<'_, DacDhr12r2Spec> {
        Dacc2dhrW::new(self, 0)
    }
    #[doc = "Bits 16:27 - DAC channel2 12-bit right-aligned data"]
    #[inline(always)]
    pub fn dacc2dhrb(&mut self) -> Dacc2dhrbW<'_, DacDhr12r2Spec> {
        Dacc2dhrbW::new(self, 16)
    }
}
...
pub struct DacDhr12r2Spec;
impl crate::RegisterSpec for DacDhr12r2Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`dac_dhr12r2::R`](R) reader structure"]
impl crate::Readable for DacDhr12r2Spec {}
#[doc = "`write(|w| ..)` method takes [`dac_dhr12r2::W`](W) writer structure"]
impl crate::Writable for DacDhr12r2Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets DAC_DHR12R2 to value 0"]
impl crate::Resettable for DacDhr12r2Spec {}
