...
impl W {
    ...
    #[doc = "Bit 12 - Word length"]
    #[inline(always)]
    pub fn m0(&mut self) -> M0W<'_, Cr1Spec> {
        M0W::new(self, 12)
    }
    #[doc = "Bit 13 - Mute mode enable"]
    #[inline(always)]
    ...
    #[doc = "Bit 16 - DEDT0"]
    #[inline(always)]
    pub fn dedt0(&mut self) -> Dedt0W<'_, Cr1Spec> {
        Dedt0W::new(self, 16)
    }
    #[doc = "Bit 17 - DEDT1"]
    #[inline(always)]
    pub fn dedt1(&mut self) -> Dedt1W<'_, Cr1Spec> {
        Dedt1W::new(self, 17)
    }
    #[doc = "Bit 18 - DEDT2"]
    #[inline(always)]
    pub fn dedt2(&mut self) -> Dedt2W<'_, Cr1Spec> {
        Dedt2W::new(self, 18)
    }
    #[doc = "Bit 19 - DEDT3"]
    #[inline(always)]
    pub fn dedt3(&mut self) -> Dedt3W<'_, Cr1Spec> {
        Dedt3W::new(self, 19)
    }
    #[doc = "Bit 20 - Driver Enable de-assertion time"]
    #[inline(always)]
    pub fn dedt4(&mut self) -> Dedt4W<'_, Cr1Spec> {
        Dedt4W::new(self, 20)
    }
    #[doc = "Bit 21 - DEAT0"]
    #[inline(always)]
    pub fn deat0(&mut self) -> Deat0W<'_, Cr1Spec> {
        Deat0W::new(self, 21)
    }
    #[doc = "Bit 22 - DEAT1"]
    #[inline(always)]
    pub fn deat1(&mut self) -> Deat1W<'_, Cr1Spec> {
        Deat1W::new(self, 22)
    }
    #[doc = "Bit 23 - DEAT2"]
    #[inline(always)]
    pub fn deat2(&mut self) -> Deat2W<'_, Cr1Spec> {
        Deat2W::new(self, 23)
    }
    #[doc = "Bit 24 - DEAT3"]
    #[inline(always)]
    pub fn deat3(&mut self) -> Deat3W<'_, Cr1Spec> {
        Deat3W::new(self, 24)
    }
    #[doc = "Bit 25 - Driver Enable assertion time"]
    #[inline(always)]
    pub fn deat4(&mut self) -> Deat4W<'_, Cr1Spec> {
        Deat4W::new(self, 25)
    }
    #[doc = "Bit 28 - Word length"]
    #[inline(always)]
    pub fn m1(&mut self) -> M1W<'_, Cr1Spec> {
        M1W::new(self, 28)
    }
    #[doc = "Bit 29 - FIFOEN"]
    #[inline(always)]
