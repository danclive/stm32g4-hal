#![doc = "Peripheral access API for STM32G431 microcontrollers (generated using svd2rust v0.35.0 ( ))\n\nYou can find an overview of the generated API [here].\n\nAPI features to be included in the [next]
...
impl Dma2 {
    #[doc = r"Pointer to the register block"]
    pub const PTR: *const dma1::RegisterBlock = 0x4000_6c00 as *const _;
    #[doc = r"Return the pointer to the register block"]
    #[inline(always)]
...
impl Peripherals {
    ...
    pub unsafe fn steal() -> Self {
        ...
        Peripherals {
            ...
            dma2: Dma2::steal(),
            adc2: Adc2::steal(),
            adc345_common: Adc345Common::steal(),
            dac2: Dac2::steal(),
            dac3: Dac3::steal(),
            dac4: Dac4::steal(),
            tim8: Tim8::steal(),
            ...
            wwdg: Wwdg::steal(),
            fdcan1: Fdcan1::steal(),
            usb_fs_device: UsbFsDevice::steal(),
            ucpd1: Ucpd1::steal(),
            dbgmcu: Dbgmcu::steal(),
        }
    }
