...
pub type R = crate::R<Opamp1TcmrSpec>;
#[doc = "Register `OPAMP1_TCMR` writer"]
pub type W = crate::W<Opamp1TcmrSpec>;
...
impl W {
    #[doc = "Bit 0 - VMS_SEL"]
    #[inline(always)]
    pub fn vms_sel(&mut self) -> VmsSelW<'_, Opamp1TcmrSpec> {
        VmsSelW::new(self, 0)
    }
    #[doc = "Bits 1:2 - VPS_SEL"]
    #[inline(always)]
    pub fn vps_sel(&mut self) -> VpsSelW<'_, Opamp1TcmrSpec> {
        VpsSelW::new(self, 1)
    }
    #[doc = "Bit 3 - T1CM_EN"]
    #[inline(always)]
    pub fn t1cm_en(&mut self) -> T1cmEnW<'_, Opamp1TcmrSpec> {
        T1cmEnW::new(self, 3)
    }
    #[doc = "Bit 4 - T8CM_EN"]
    #[inline(always)]
    pub fn t8cm_en(&mut self) -> T8cmEnW<'_, Opamp1TcmrSpec> {
        T8cmEnW::new(self, 4)
    }
    #[doc = "Bit 5 - T20CM_EN"]
    #[inline(always)]
    pub fn t20cm_en(&mut self) -> T20cmEnW<'_, Opamp1TcmrSpec> {
        T20cmEnW::new(self, 5)
    }
    #[doc = "Bit 31 - LOCK"]
    #[inline(always)]
    pub fn lock(&mut self) -> LockW<'_, Opamp1TcmrSpec> {
        LockW::new(self, 31)
    }
}
...
pub struct Opamp1TcmrSpec;
impl crate::RegisterSpec for Opamp1TcmrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`opamp1_tcmr::R`](R) reader structure"]
impl crate::Readable for Opamp1TcmrSpec {}
