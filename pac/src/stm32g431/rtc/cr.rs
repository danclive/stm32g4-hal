...
impl W {
    ...
    #[doc = "Bit 24 - timestamp on internal event enable"]
    #[inline(always)]
    pub fn itse(&mut self) -> ItseW<'_, CrSpec> {
        ItseW::new(self, 24)
    }
    #[doc = "Bit 25 - TAMPTS"]
    #[inline(always)]
    pub fn tampts(&mut self) -> TamptsW<'_, CrSpec> {
        TamptsW::new(self, 25)
    }
    #[doc = "Bit 26 - TAMPOE"]
    #[inline(always)]
    pub fn tampoe(&mut self) -> TampoeW<'_, CrSpec> {
        TampoeW::new(self, 26)
    }
    #[doc = "Bit 29 - TAMPALRM_PU"]
    #[inline(always)]
    pub fn tampalrm_pu(&mut self) -> TampalrmPuW<'_, CrSpec> {
        TampalrmPuW::new(self, 29)
    }
    #[doc = "Bit 30 - TAMPALRM_TYPE"]
    #[inline(always)]
    pub fn tampalrm_type(&mut self) -> TampalrmTypeW<'_, CrSpec> {
        TampalrmTypeW::new(self, 30)
    }
    #[doc = "Bit 31 - OUT2EN"]
    #[inline(always)]
    pub fn out2en(&mut self) -> Out2enW<'_, CrSpec> {
        Out2enW::new(self, 31)
    }
}
