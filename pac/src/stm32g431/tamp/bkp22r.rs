...
pub type R = crate::R<Bkp22rSpec>;
#[doc = "Register `BKP22R` writer"]
pub type W = crate::W<Bkp22rSpec>;
...
impl W {
    #[doc = "Bits 0:31 - BKP"]
    #[inline(always)]
    pub fn bkp(&mut self) -> BkpW<'_, Bkp22rSpec> {
        BkpW::new(self, 0)
    }
}
...
pub struct Bkp22rSpec;
impl crate::RegisterSpec for Bkp22rSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`bkp22r::R`](R) reader structure"]
impl crate::Readable for Bkp22rSpec {}
#[doc = "`write(|w| ..)` method takes [`bkp22r::W`](W) writer structure"]
impl crate::Writable for Bkp22rSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets BKP22R to value 0"]
impl crate::Resettable for Bkp22rSpec {}
