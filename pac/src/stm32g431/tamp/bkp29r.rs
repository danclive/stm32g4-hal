...
pub type R = crate::R<Bkp29rSpec>;
#[doc = "Register `BKP29R` writer"]
pub type W = crate::W<Bkp29rSpec>;
...
impl W {
    #[doc = "Bits 0:31 - BKP"]
    #[inline(always)]
    pub fn bkp(&mut self) -> BkpW<'_, Bkp29rSpec> {
        BkpW::new(self, 0)
    }
}
...
pub struct Bkp29rSpec;
impl crate::RegisterSpec for Bkp29rSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`bkp29r::R`](R) reader structure"]
impl crate::Readable for Bkp29rSpec {}
#[doc = "`write(|w| ..)` method takes [`bkp29r::W`](W) writer structure"]
impl crate::Writable for Bkp29rSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets BKP29R to value 0"]
impl crate::Resettable for Bkp29rSpec {}
