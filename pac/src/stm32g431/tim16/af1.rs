...
impl W {
    ...
    #[doc = "Bit 2 - BRK COMP2 enable"]
    #[inline(always)]
    pub fn bkcmp2e(&mut self) -> Bkcmp2eW<'_, Af1Spec> {
        Bkcmp2eW::new(self, 2)
    }
    #[doc = "Bit 3 - BRK COMP3 enable"]
    #[inline(always)]
    pub fn bkcmp3e(&mut self) -> Bkcmp3eW<'_, Af1Spec> {
        Bkcmp3eW::new(self, 3)
    }
    #[doc = "Bit 4 - BRK COMP4 enable"]
    #[inline(always)]
    pub fn bkcmp4e(&mut self) -> Bkcmp4eW<'_, Af1Spec> {
        Bkcmp4eW::new(self, 4)
    }
    #[doc = "Bit 5 - BRK COMP5 enable"]
    #[inline(always)]
    pub fn bkcmp5e(&mut self) -> Bkcmp5eW<'_, Af1Spec> {
        Bkcmp5eW::new(self, 5)
    }
    #[doc = "Bit 6 - BRK COMP6 enable"]
    #[inline(always)]
    pub fn bkcmp6e(&mut self) -> Bkcmp6eW<'_, Af1Spec> {
        Bkcmp6eW::new(self, 6)
    }
    #[doc = "Bit 7 - BRK COMP7 enable"]
    #[inline(always)]
    pub fn bkcmp7e(&mut self) -> Bkcmp7eW<'_, Af1Spec> {
        Bkcmp7eW::new(self, 7)
    }
    #[doc = "Bit 9 - BRK BKIN input polarity"]
    #[inline(always)]
    ...
    #[doc = "Bit 11 - BRK COMP2 input polarity"]
    #[inline(always)]
    pub fn bkcmp2p(&mut self) -> Bkcmp2pW<'_, Af1Spec> {
        Bkcmp2pW::new(self, 11)
    }
    #[doc = "Bit 12 - BRK COMP3 input polarity"]
    #[inline(always)]
    pub fn bkcmp3p(&mut self) -> Bkcmp3pW<'_, Af1Spec> {
        Bkcmp3pW::new(self, 12)
    }
    #[doc = "Bit 13 - BRK COMP4 input polarity"]
    #[inline(always)]
    pub fn bkcmp4p(&mut self) -> Bkcmp4pW<'_, Af1Spec> {
