...
impl W {
    #[doc = "Bit 0 - TXISIE"]
    #[inline(always)]
    pub fn txisie(&mut self) -> TxisieW<'_, ImrSpec> {
        TxisieW::new(self, 0)
    }
    #[doc = "Bit 1 - TXMSGDISCIE"]
    #[inline(always)]
    pub fn txmsgdiscie(&mut self) -> TxmsgdiscieW<'_, ImrSpec> {
        TxmsgdiscieW::new(self, 1)
    }
    #[doc = "Bit 2 - TXMSGSENTIE"]
    #[inline(always)]
    pub fn txmsgsentie(&mut self) -> TxmsgsentieW<'_, ImrSpec> {
        TxmsgsentieW::new(self, 2)
    }
    #[doc = "Bit 3 - TXMSGABTIE"]
    #[inline(always)]
    pub fn txmsgabtie(&mut self) -> TxmsgabtieW<'_, ImrSpec> {
        TxmsgabtieW::new(self, 3)
    }
    #[doc = "Bit 4 - HRSTDISCIE"]
    #[inline(always)]
    pub fn hrstdiscie(&mut self) -> HrstdiscieW<'_, ImrSpec> {
        HrstdiscieW::new(self, 4)
    }
    #[doc = "Bit 5 - HRSTSENTIE"]
    #[inline(always)]
    pub fn hrstsentie(&mut self) -> HrstsentieW<'_, ImrSpec> {
        HrstsentieW::new(self, 5)
    }
    #[doc = "Bit 6 - TXUNDIE"]
    #[inline(always)]
    pub fn txundie(&mut self) -> TxundieW<'_, ImrSpec> {
        TxundieW::new(self, 6)
    }
    #[doc = "Bit 8 - RXNEIE"]
    #[inline(always)]
    pub fn rxneie(&mut self) -> RxneieW<'_, ImrSpec> {
        RxneieW::new(self, 8)
    }
    #[doc = "Bit 9 - RXORDDETIE"]
    #[inline(always)]
    pub fn rxorddetie(&mut self) -> RxorddetieW<'_, ImrSpec> {
        RxorddetieW::new(self, 9)
    }
    #[doc = "Bit 10 - RXHRSTDETIE"]
    #[inline(always)]
    pub fn rxhrstdetie(&mut self) -> RxhrstdetieW<'_, ImrSpec> {
        RxhrstdetieW::new(self, 10)
    }
    #[doc = "Bit 11 - RXOVRIE"]
    #[inline(always)]
    pub fn rxovrie(&mut self) -> RxovrieW<'_, ImrSpec> {
        RxovrieW::new(self, 11)
    }
    #[doc = "Bit 12 - RXMSGENDIE"]
    #[inline(always)]
    pub fn rxmsgendie(&mut self) -> RxmsgendieW<'_, ImrSpec> {
        RxmsgendieW::new(self, 12)
    }
    #[doc = "Bit 14 - TYPECEVT1IE"]
    #[inline(always)]
    pub fn typecevt1ie(&mut self) -> Typecevt1ieW<'_, ImrSpec> {
        Typecevt1ieW::new(self, 14)
    }
    #[doc = "Bit 15 - TYPECEVT2IE"]
    #[inline(always)]
    pub fn typecevt2ie(&mut self) -> Typecevt2ieW<'_, ImrSpec> {
        Typecevt2ieW::new(self, 15)
    }
    #[doc = "Bit 20 - FRSEVTIE"]
    #[inline(always)]
    pub fn frsevtie(&mut self) -> FrsevtieW<'_, ImrSpec> {
