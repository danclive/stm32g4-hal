...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn opaen(&mut self) -> OpaenW<Opamp4CsrSpec> {
        OpaenW::new(self, 0)
    }
    #[doc = "Bit 1 - FORCE_VP"]
    #[inline(always)]
    ...
    #[inline(always)]
    #[must_use]
    pub fn usertrim(&mut self) -> UsertrimW<Opamp4CsrSpec> {
    ...
    #[inline(always)]
    #[must_use]
    pub fn opahsm(&mut self) -> OpahsmW<Opamp4CsrSpec> {
        OpahsmW::new(self, 7)
    }
    #[doc = "Bit 8 - OPAINTOEN"]
    #[inline(always)]
    #[must_use]
    pub fn opaintoen(&mut self) -> OpaintoenW<Opamp4CsrSpec> {
    ...
    #[inline(always)]
    #[must_use]
    pub fn calout(&mut self) -> CaloutW<Opamp4CsrSpec> {
        CaloutW::new(self, 30)
    }
    #[doc = "Bit 31 - LOCK"]
    #[inline(always)]
