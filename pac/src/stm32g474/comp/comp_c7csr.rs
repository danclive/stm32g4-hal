...
pub type R = crate::R<CompC7csrSpec>;
#[doc = "Register `COMP_C7CSR` writer"]
pub type W = crate::W<CompC7csrSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn en(&mut self) -> EnW<CompC7csrSpec> {
        EnW::new(self, 0)
    }
    #[doc = "Bits 4:6 - INMSEL"]
    #[inline(always)]
    #[must_use]
    pub fn inmsel(&mut self) -> InmselW<CompC7csrSpec> {
        InmselW::new(self, 4)
    }
    #[doc = "Bit 8 - INPSEL"]
    #[inline(always)]
    #[must_use]
    pub fn inpsel(&mut self) -> InpselW<CompC7csrSpec> {
        InpselW::new(self, 8)
    }
    #[doc = "Bit 15 - POL"]
    #[inline(always)]
    #[must_use]
    pub fn pol(&mut self) -> PolW<CompC7csrSpec> {
        PolW::new(self, 15)
    }
    #[doc = "Bits 16:18 - HYST"]
    #[inline(always)]
    #[must_use]
    pub fn hyst(&mut self) -> HystW<CompC7csrSpec> {
        HystW::new(self, 16)
    }
    #[doc = "Bits 19:21 - BLANKSEL"]
    #[inline(always)]
    #[must_use]
    pub fn blanksel(&mut self) -> BlankselW<CompC7csrSpec> {
        BlankselW::new(self, 19)
    }
    #[doc = "Bit 22 - BRGEN"]
    #[inline(always)]
    #[must_use]
    pub fn brgen(&mut self) -> BrgenW<CompC7csrSpec> {
        BrgenW::new(self, 22)
    }
    #[doc = "Bit 23 - SCALEN"]
    #[inline(always)]
    #[must_use]
    pub fn scalen(&mut self) -> ScalenW<CompC7csrSpec> {
        ScalenW::new(self, 23)
    }
    #[doc = "Bit 31 - LOCK"]
    #[inline(always)]
    #[must_use]
    pub fn lock(&mut self) -> LockW<CompC7csrSpec> {
        LockW::new(self, 31)
    }
}
#[doc = "Comparator control/status register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`comp_c7csr::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`comp_c7csr::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct CompC7csrSpec;
impl crate::RegisterSpec for CompC7csrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`comp_c7csr::R`](R) reader structure"]
impl crate::Readable for CompC7csrSpec {}
#[doc = "`write(|w| ..)` method takes [`comp_c7csr::W`](W) writer structure"]
impl crate::Writable for CompC7csrSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets COMP_C7CSR to value 0"]
impl crate::Resettable for CompC7csrSpec {
