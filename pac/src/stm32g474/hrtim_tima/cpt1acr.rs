...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tf1set(&mut self) -> Tf1setW<Cpt1acrSpec> {
        Tf1setW::new(self, 12)
    }
    #[doc = "Bit 13 - TF1RST"]
    #[inline(always)]
    #[must_use]
    pub fn tf1rst(&mut self) -> Tf1rstW<Cpt1acrSpec> {
        Tf1rstW::new(self, 13)
    }
    #[doc = "Bit 14 - TFCMP1"]
    #[inline(always)]
    #[must_use]
    pub fn tfcmp1(&mut self) -> Tfcmp1W<Cpt1acrSpec> {
        Tfcmp1W::new(self, 14)
    }
    #[doc = "Bit 15 - TFCMP2"]
    #[inline(always)]
    #[must_use]
    pub fn tfcmp2(&mut self) -> Tfcmp2W<Cpt1acrSpec> {
        Tfcmp2W::new(self, 15)
    }
    #[doc = "Bit 16 - Timer B output 1 Set"]
    #[inline(always)]
