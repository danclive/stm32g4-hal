...
pub type R = crate::R<Beefr3Spec>;
#[doc = "Register `BEEFR3` writer"]
pub type W = crate::W<Beefr3Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn eevace(&mut self) -> EevaceW<Beefr3Spec> {
        EevaceW::new(self, 0)
    }
    #[doc = "Bit 1 - External Event A Counter Reset"]
    #[inline(always)]
    #[must_use]
    pub fn eevacres(&mut self) -> EevacresW<Beefr3Spec> {
        EevacresW::new(self, 1)
    }
    #[doc = "Bit 2 - External Event A Reset Mode"]
    #[inline(always)]
    #[must_use]
    pub fn eevarstm(&mut self) -> EevarstmW<Beefr3Spec> {
        EevarstmW::new(self, 2)
    }
    #[doc = "Bits 4:7 - External Event A Selection"]
    #[inline(always)]
    #[must_use]
    pub fn eevasel(&mut self) -> EevaselW<Beefr3Spec> {
        EevaselW::new(self, 4)
    }
    #[doc = "Bits 8:13 - External Event A counter"]
    #[inline(always)]
    #[must_use]
    pub fn eevacnt(&mut self) -> EevacntW<Beefr3Spec> {
        EevacntW::new(self, 8)
    }
}
...
pub struct Beefr3Spec;
impl crate::RegisterSpec for Beefr3Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`beefr3::R`](R) reader structure"]
impl crate::Readable for Beefr3Spec {}
#[doc = "`write(|w| ..)` method takes [`beefr3::W`](W) writer structure"]
impl crate::Writable for Beefr3Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets BEEFR3 to value 0"]
impl crate::Resettable for Beefr3Spec {
