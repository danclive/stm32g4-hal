...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tf1set(&mut self) -> Tf1setW<Cpt2bcrSpec> {
        Tf1setW::new(self, 16)
    }
    #[doc = "Bit 17 - TF1RST"]
    #[inline(always)]
    #[must_use]
    pub fn tf1rst(&mut self) -> Tf1rstW<Cpt2bcrSpec> {
        Tf1rstW::new(self, 17)
    }
    #[doc = "Bit 18 - TFCMP1"]
    #[inline(always)]
    #[must_use]
    pub fn tfcmp1(&mut self) -> Tfcmp1W<Cpt2bcrSpec> {
        Tfcmp1W::new(self, 18)
    }
    #[doc = "Bit 19 - TFCMP2"]
    #[inline(always)]
    #[must_use]
    pub fn tfcmp2(&mut self) -> Tfcmp2W<Cpt2bcrSpec> {
        Tfcmp2W::new(self, 19)
    }
    #[doc = "Bit 20 - Timer C output 1 Set"]
    #[inline(always)]
