...
impl R {
    ...
    pub fn tfcmp1(&self) -> Tfcmp1R {
        Tfcmp1R::new(((self.bits >> 22) & 1) != 0)
    }
    #[doc = "Bit 23 - TFCMP2"]
    #[inline(always)]
    pub fn tfcmp2(&self) -> Tfcmp2R {
        Tfcmp2R::new(((self.bits >> 23) & 1) != 0)
    }
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tf1set(&mut self) -> Tf1setW<Cpt1ccrSpec> {
        Tf1setW::new(self, 20)
    }
    #[doc = "Bit 21 - TF1RST"]
    #[inline(always)]
    #[must_use]
    pub fn tf1rst(&mut self) -> Tf1rstW<Cpt1ccrSpec> {
        Tf1rstW::new(self, 21)
    }
    #[doc = "Bit 22 - TFCMP1"]
    #[inline(always)]
    #[must_use]
    pub fn tfcmp1(&mut self) -> Tfcmp1W<Cpt1ccrSpec> {
        Tfcmp1W::new(self, 22)
    }
    #[doc = "Bit 23 - TFCMP2"]
    #[inline(always)]
    #[must_use]
    pub fn tfcmp2(&mut self) -> Tfcmp2W<Cpt1ccrSpec> {
        Tfcmp2W::new(self, 23)
    }
    #[doc = "Bit 24 - Timer D output 1 Set"]
    #[inline(always)]
