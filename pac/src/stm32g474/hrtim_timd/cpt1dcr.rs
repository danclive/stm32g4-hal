...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tf1set(&mut self) -> Tf1setW<Cpt1dcrSpec> {
        Tf1setW::new(self, 24)
    }
    #[doc = "Bit 25 - TF1RST"]
    #[inline(always)]
    #[must_use]
    pub fn tf1rst(&mut self) -> Tf1rstW<Cpt1dcrSpec> {
        Tf1rstW::new(self, 25)
    }
    #[doc = "Bit 26 - TFCMP1"]
    #[inline(always)]
    #[must_use]
    pub fn tfcmp1(&mut self) -> Tfcmp1W<Cpt1dcrSpec> {
        Tfcmp1W::new(self, 26)
    }
    #[doc = "Bit 27 - TFCMP2"]
    #[inline(always)]
    #[must_use]
    pub fn tfcmp2(&mut self) -> Tfcmp2W<Cpt1dcrSpec> {
        Tfcmp2W::new(self, 27)
    }
    #[doc = "Bit 28 - Timer E output 1 Set"]
    #[inline(always)]
