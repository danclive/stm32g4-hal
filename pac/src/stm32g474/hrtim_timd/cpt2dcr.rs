...
impl R {
    ...
    pub fn tf1set(&self) -> Tf1setR {
        Tf1setR::new(((self.bits >> 24) & 1) != 0)
    }
    #[doc = "Bit 25 - TF1RST"]
    #[inline(always)]
    pub fn tf1rst(&self) -> Tf1rstR {
        Tf1rstR::new(((self.bits >> 25) & 1) != 0)
    }
    #[doc = "Bit 26 - TFCMP1"]
    #[inline(always)]
    pub fn tfcmp1(&self) -> Tfcmp1R {
        Tfcmp1R::new(((self.bits >> 26) & 1) != 0)
    }
    #[doc = "Bit 27 - TFCMP2"]
    #[inline(always)]
    pub fn tfcmp2(&self) -> Tfcmp2R {
        Tfcmp2R::new(((self.bits >> 27) & 1) != 0)
    }
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tf1set(&mut self) -> Tf1setW<Cpt2dcrSpec> {
        Tf1setW::new(self, 24)
    }
    #[doc = "Bit 25 - TF1RST"]
    #[inline(always)]
    #[must_use]
    pub fn tf1rst(&mut self) -> Tf1rstW<Cpt2dcrSpec> {
        Tf1rstW::new(self, 25)
    }
    #[doc = "Bit 26 - TFCMP1"]
    #[inline(always)]
    #[must_use]
    pub fn tfcmp1(&mut self) -> Tfcmp1W<Cpt2dcrSpec> {
        Tfcmp1W::new(self, 26)
    }
    #[doc = "Bit 27 - TFCMP2"]
    #[inline(always)]
    #[must_use]
    pub fn tfcmp2(&mut self) -> Tfcmp2W<Cpt2dcrSpec> {
        Tfcmp2W::new(self, 27)
    }
    #[doc = "Bit 28 - Timer E output 1 Set"]
    #[inline(always)]
