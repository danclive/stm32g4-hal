...
impl R {
    ...
    pub fn tf1set(&self) -> Tf1setR {
        Tf1setR::new(((self.bits >> 28) & 1) != 0)
    }
    #[doc = "Bit 29 - TF1RST"]
    #[inline(always)]
    pub fn tf1rst(&self) -> Tf1rstR {
        Tf1rstR::new(((self.bits >> 29) & 1) != 0)
    }
    #[doc = "Bit 30 - TFCMP1"]
    #[inline(always)]
    pub fn tfcmp1(&self) -> Tfcmp1R {
        Tfcmp1R::new(((self.bits >> 30) & 1) != 0)
    }
    #[doc = "Bit 31 - TFCMP2"]
    #[inline(always)]
    pub fn tfcmp2(&self) -> Tfcmp2R {
        Tfcmp2R::new(((self.bits >> 31) & 1) != 0)
    }
}
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tf1set(&mut self) -> Tf1setW<Cpt1ecrSpec> {
        Tf1setW::new(self, 28)
    }
    #[doc = "Bit 29 - TF1RST"]
    #[inline(always)]
    #[must_use]
    pub fn tf1rst(&mut self) -> Tf1rstW<Cpt1ecrSpec> {
        Tf1rstW::new(self, 29)
    }
    #[doc = "Bit 30 - TFCMP1"]
    #[inline(always)]
    #[must_use]
    pub fn tfcmp1(&mut self) -> Tfcmp1W<Cpt1ecrSpec> {
        Tfcmp1W::new(self, 30)
    }
    #[doc = "Bit 31 - TFCMP2"]
    #[inline(always)]
    #[must_use]
    pub fn tfcmp2(&mut self) -> Tfcmp2W<Cpt1ecrSpec> {
        Tfcmp2W::new(self, 31)
    }
}
