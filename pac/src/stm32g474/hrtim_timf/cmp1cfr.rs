...
pub type R = crate::R<Cmp1cfrSpec>;
#[doc = "Register `CMP1CFR` writer"]
pub type W = crate::W<Cmp1cfrSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn cmp1x(&mut self) -> Cmp1xW<Cmp1cfrSpec> {
        Cmp1xW::new(self, 0)
    }
    #[doc = "Bits 16:23 - Timerx Repetition value (aliased from HRTIM_REPx register)"]
    #[inline(always)]
    #[must_use]
    pub fn repx(&mut self) -> RepxW<Cmp1cfrSpec> {
        RepxW::new(self, 16)
    }
}
...
pub struct Cmp1cfrSpec;
impl crate::RegisterSpec for Cmp1cfrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`cmp1cfr::R`](R) reader structure"]
impl crate::Readable for Cmp1cfrSpec {}
#[doc = "`write(|w| ..)` method takes [`cmp1cfr::W`](W) writer structure"]
impl crate::Writable for Cmp1cfrSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets CMP1CFR to value 0"]
impl crate::Resettable for Cmp1cfrSpec {
