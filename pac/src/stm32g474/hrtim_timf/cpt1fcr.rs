...
pub type R = crate::R<Cpt1fcrSpec>;
#[doc = "Register `CPT1FCR` writer"]
pub type W = crate::W<Cpt1fcrSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn swcpt(&mut self) -> SwcptW<Cpt1fcrSpec> {
        SwcptW::new(self, 0)
    }
    #[doc = "Bit 1 - Update Capture"]
    #[inline(always)]
    #[must_use]
    pub fn udpcpt(&mut self) -> UdpcptW<Cpt1fcrSpec> {
        UdpcptW::new(self, 1)
    }
    #[doc = "Bit 2 - External Event 1 Capture"]
    #[inline(always)]
    #[must_use]
    pub fn exev1cpt(&mut self) -> Exev1cptW<Cpt1fcrSpec> {
        Exev1cptW::new(self, 2)
    }
    #[doc = "Bit 3 - External Event 2 Capture"]
    #[inline(always)]
    #[must_use]
    pub fn exev2cpt(&mut self) -> Exev2cptW<Cpt1fcrSpec> {
        Exev2cptW::new(self, 3)
    }
    #[doc = "Bit 4 - External Event 3 Capture"]
    #[inline(always)]
    #[must_use]
    pub fn exev3cpt(&mut self) -> Exev3cptW<Cpt1fcrSpec> {
        Exev3cptW::new(self, 4)
    }
    #[doc = "Bit 5 - External Event 4 Capture"]
    #[inline(always)]
    #[must_use]
    pub fn exev4cpt(&mut self) -> Exev4cptW<Cpt1fcrSpec> {
        Exev4cptW::new(self, 5)
    }
    #[doc = "Bit 6 - External Event 5 Capture"]
    #[inline(always)]
    #[must_use]
    pub fn exev5cpt(&mut self) -> Exev5cptW<Cpt1fcrSpec> {
        Exev5cptW::new(self, 6)
    }
    #[doc = "Bit 7 - External Event 6 Capture"]
    #[inline(always)]
    #[must_use]
    pub fn exev6cpt(&mut self) -> Exev6cptW<Cpt1fcrSpec> {
        Exev6cptW::new(self, 7)
    }
    #[doc = "Bit 8 - External Event 7 Capture"]
    #[inline(always)]
    #[must_use]
    pub fn exev7cpt(&mut self) -> Exev7cptW<Cpt1fcrSpec> {
        Exev7cptW::new(self, 8)
    }
    #[doc = "Bit 9 - External Event 8 Capture"]
    #[inline(always)]
    #[must_use]
    pub fn exev8cpt(&mut self) -> Exev8cptW<Cpt1fcrSpec> {
        Exev8cptW::new(self, 9)
    }
    #[doc = "Bit 10 - External Event 9 Capture"]
    #[inline(always)]
    #[must_use]
    pub fn exev9cpt(&mut self) -> Exev9cptW<Cpt1fcrSpec> {
        Exev9cptW::new(self, 10)
    }
    #[doc = "Bit 11 - External Event 10 Capture"]
    #[inline(always)]
    #[must_use]
    pub fn exev10cpt(&mut self) -> Exev10cptW<Cpt1fcrSpec> {
        Exev10cptW::new(self, 11)
    }
    #[doc = "Bit 12 - Timer A output 1 Set"]
    #[inline(always)]
    #[must_use]
    pub fn ta1set(&mut self) -> Ta1setW<Cpt1fcrSpec> {
        Ta1setW::new(self, 12)
    }
    #[doc = "Bit 13 - Timer A output 1 Reset"]
    #[inline(always)]
    #[must_use]
    pub fn ta1rst(&mut self) -> Ta1rstW<Cpt1fcrSpec> {
        Ta1rstW::new(self, 13)
    }
    #[doc = "Bit 14 - Timer A Compare 1"]
    #[inline(always)]
    #[must_use]
    pub fn tacmp1(&mut self) -> Tacmp1W<Cpt1fcrSpec> {
        Tacmp1W::new(self, 14)
    }
    #[doc = "Bit 15 - Timer A Compare 2"]
    #[inline(always)]
    #[must_use]
    pub fn tacmp2(&mut self) -> Tacmp2W<Cpt1fcrSpec> {
        Tacmp2W::new(self, 15)
    }
    #[doc = "Bit 16 - Timer B output 1 Set"]
    #[inline(always)]
    #[must_use]
    pub fn tb1set(&mut self) -> Tb1setW<Cpt1fcrSpec> {
        Tb1setW::new(self, 16)
    }
    #[doc = "Bit 17 - Timer B output 1 Reset"]
    #[inline(always)]
    #[must_use]
    pub fn tb1rst(&mut self) -> Tb1rstW<Cpt1fcrSpec> {
        Tb1rstW::new(self, 17)
    }
    #[doc = "Bit 18 - Timer B Compare 1"]
    #[inline(always)]
    #[must_use]
    pub fn tbcmp1(&mut self) -> Tbcmp1W<Cpt1fcrSpec> {
        Tbcmp1W::new(self, 18)
    }
    #[doc = "Bit 19 - Timer B Compare 2"]
    #[inline(always)]
    #[must_use]
    pub fn tbcmp2(&mut self) -> Tbcmp2W<Cpt1fcrSpec> {
        Tbcmp2W::new(self, 19)
    }
    #[doc = "Bit 20 - Timer C output 1 Set"]
    #[inline(always)]
    #[must_use]
    pub fn tc1set(&mut self) -> Tc1setW<Cpt1fcrSpec> {
        Tc1setW::new(self, 20)
    }
    #[doc = "Bit 21 - Timer C output 1 Reset"]
    #[inline(always)]
    #[must_use]
    pub fn tc1rst(&mut self) -> Tc1rstW<Cpt1fcrSpec> {
        Tc1rstW::new(self, 21)
    }
    #[doc = "Bit 22 - Timer C Compare 1"]
    #[inline(always)]
    #[must_use]
    pub fn tccmp1(&mut self) -> Tccmp1W<Cpt1fcrSpec> {
        Tccmp1W::new(self, 22)
    }
    #[doc = "Bit 23 - Timer C Compare 2"]
    #[inline(always)]
    #[must_use]
    pub fn tccmp2(&mut self) -> Tccmp2W<Cpt1fcrSpec> {
        Tccmp2W::new(self, 23)
    }
    #[doc = "Bit 24 - Timer D output 1 Set"]
    #[inline(always)]
    #[must_use]
    pub fn td1set(&mut self) -> Td1setW<Cpt1fcrSpec> {
        Td1setW::new(self, 24)
    }
    #[doc = "Bit 25 - Timer D output 1 Reset"]
    #[inline(always)]
    #[must_use]
    pub fn td1rst(&mut self) -> Td1rstW<Cpt1fcrSpec> {
        Td1rstW::new(self, 25)
    }
    #[doc = "Bit 26 - Timer D Compare 1"]
    #[inline(always)]
    #[must_use]
    pub fn tdcmp1(&mut self) -> Tdcmp1W<Cpt1fcrSpec> {
        Tdcmp1W::new(self, 26)
    }
    #[doc = "Bit 27 - Timer D Compare 2"]
    #[inline(always)]
    #[must_use]
    pub fn tdcmp2(&mut self) -> Tdcmp2W<Cpt1fcrSpec> {
        Tdcmp2W::new(self, 27)
    }
    #[doc = "Bit 28 - TE1SET"]
    #[inline(always)]
    #[must_use]
    pub fn te1set(&mut self) -> Te1setW<Cpt1fcrSpec> {
        Te1setW::new(self, 28)
    }
    #[doc = "Bit 29 - TE1RST"]
    #[inline(always)]
    #[must_use]
    pub fn te1rst(&mut self) -> Te1rstW<Cpt1fcrSpec> {
        Te1rstW::new(self, 29)
    }
    #[doc = "Bit 30 - TECMP1"]
    #[inline(always)]
    #[must_use]
    pub fn tecmp1(&mut self) -> Tecmp1W<Cpt1fcrSpec> {
        Tecmp1W::new(self, 30)
    }
    #[doc = "Bit 31 - TECMP2"]
    #[inline(always)]
    #[must_use]
    pub fn tecmp2(&mut self) -> Tecmp2W<Cpt1fcrSpec> {
        Tecmp2W::new(self, 31)
    }
}
...
pub struct Cpt1fcrSpec;
impl crate::RegisterSpec for Cpt1fcrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`cpt1fcr::R`](R) reader structure"]
impl crate::Readable for Cpt1fcrSpec {}
#[doc = "`write(|w| ..)` method takes [`cpt1fcr::W`](W) writer structure"]
impl crate::Writable for Cpt1fcrSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets CPT1FCR to value 0"]
impl crate::Resettable for Cpt1fcrSpec {
