...
pub type R = crate::R<Eeffr1Spec>;
#[doc = "Register `EEFFR1` writer"]
pub type W = crate::W<Eeffr1Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ee1ltch(&mut self) -> Ee1ltchW<Eeffr1Spec> {
        Ee1ltchW::new(self, 0)
    }
    #[doc = "Bits 1:4 - External Event 1 filter"]
    #[inline(always)]
    #[must_use]
    pub fn ee1fltr(&mut self) -> Ee1fltrW<Eeffr1Spec> {
        Ee1fltrW::new(self, 1)
    }
    #[doc = "Bit 6 - External Event 2 latch"]
    #[inline(always)]
    #[must_use]
    pub fn ee2ltch(&mut self) -> Ee2ltchW<Eeffr1Spec> {
        Ee2ltchW::new(self, 6)
    }
    #[doc = "Bits 7:10 - External Event 2 filter"]
    #[inline(always)]
    #[must_use]
    pub fn ee2fltr(&mut self) -> Ee2fltrW<Eeffr1Spec> {
        Ee2fltrW::new(self, 7)
    }
    #[doc = "Bit 12 - External Event 3 latch"]
    #[inline(always)]
    #[must_use]
    pub fn ee3ltch(&mut self) -> Ee3ltchW<Eeffr1Spec> {
        Ee3ltchW::new(self, 12)
    }
    #[doc = "Bits 13:16 - External Event 3 filter"]
    #[inline(always)]
    #[must_use]
    pub fn ee3fltr(&mut self) -> Ee3fltrW<Eeffr1Spec> {
        Ee3fltrW::new(self, 13)
    }
    #[doc = "Bit 18 - External Event 4 latch"]
    #[inline(always)]
    #[must_use]
    pub fn ee4ltch(&mut self) -> Ee4ltchW<Eeffr1Spec> {
        Ee4ltchW::new(self, 18)
    }
    #[doc = "Bits 19:22 - External Event 4 filter"]
    #[inline(always)]
    #[must_use]
    pub fn ee4fltr(&mut self) -> Ee4fltrW<Eeffr1Spec> {
        Ee4fltrW::new(self, 19)
    }
    #[doc = "Bit 24 - External Event 5 latch"]
    #[inline(always)]
    #[must_use]
    pub fn ee5ltch(&mut self) -> Ee5ltchW<Eeffr1Spec> {
        Ee5ltchW::new(self, 24)
    }
    #[doc = "Bits 25:28 - External Event 5 filter"]
    #[inline(always)]
    #[must_use]
    pub fn ee5fltr(&mut self) -> Ee5fltrW<Eeffr1Spec> {
...
pub struct Eeffr1Spec;
impl crate::RegisterSpec for Eeffr1Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`eeffr1::R`](R) reader structure"]
impl crate::Readable for Eeffr1Spec {}
#[doc = "`write(|w| ..)` method takes [`eeffr1::W`](W) writer structure"]
impl crate::Writable for Eeffr1Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets EEFFR1 to value 0"]
impl crate::Resettable for Eeffr1Spec {
