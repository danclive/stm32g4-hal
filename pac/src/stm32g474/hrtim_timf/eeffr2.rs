...
pub type R = crate::R<Eeffr2Spec>;
#[doc = "Register `EEFFR2` writer"]
pub type W = crate::W<Eeffr2Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ee6ltch(&mut self) -> Ee6ltchW<Eeffr2Spec> {
        Ee6ltchW::new(self, 0)
    }
    #[doc = "Bits 1:4 - External Event 6 filter"]
    #[inline(always)]
    #[must_use]
    pub fn ee6fltr(&mut self) -> Ee6fltrW<Eeffr2Spec> {
        Ee6fltrW::new(self, 1)
    }
    #[doc = "Bit 6 - External Event 7 latch"]
    #[inline(always)]
    #[must_use]
    pub fn ee7ltch(&mut self) -> Ee7ltchW<Eeffr2Spec> {
        Ee7ltchW::new(self, 6)
    }
    #[doc = "Bits 7:10 - External Event 7 filter"]
    #[inline(always)]
    #[must_use]
    pub fn ee7fltr(&mut self) -> Ee7fltrW<Eeffr2Spec> {
        Ee7fltrW::new(self, 7)
    }
    #[doc = "Bit 12 - External Event 8 latch"]
    #[inline(always)]
    #[must_use]
    pub fn ee8ltch(&mut self) -> Ee8ltchW<Eeffr2Spec> {
        Ee8ltchW::new(self, 12)
    }
    #[doc = "Bits 13:16 - External Event 8 filter"]
    #[inline(always)]
    #[must_use]
    pub fn ee8fltr(&mut self) -> Ee8fltrW<Eeffr2Spec> {
        Ee8fltrW::new(self, 13)
    }
    #[doc = "Bit 18 - External Event 9 latch"]
    #[inline(always)]
    #[must_use]
    pub fn ee9ltch(&mut self) -> Ee9ltchW<Eeffr2Spec> {
        Ee9ltchW::new(self, 18)
    }
    #[doc = "Bits 19:22 - External Event 9 filter"]
    #[inline(always)]
    #[must_use]
    pub fn ee9fltr(&mut self) -> Ee9fltrW<Eeffr2Spec> {
        Ee9fltrW::new(self, 19)
    }
    #[doc = "Bit 24 - External Event 10 latch"]
    #[inline(always)]
    #[must_use]
    pub fn ee10ltch(&mut self) -> Ee10ltchW<Eeffr2Spec> {
        Ee10ltchW::new(self, 24)
    }
    #[doc = "Bits 25:28 - External Event 10 filter"]
    #[inline(always)]
    #[must_use]
    pub fn ee10fltr(&mut self) -> Ee10fltrW<Eeffr2Spec> {
        Ee10fltrW::new(self, 25)
    }
}
#[doc = "Timerx External Event Filtering Register 2\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`eeffr2::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`eeffr2::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Eeffr2Spec;
impl crate::RegisterSpec for Eeffr2Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`eeffr2::R`](R) reader structure"]
impl crate::Readable for Eeffr2Spec {}
#[doc = "`write(|w| ..)` method takes [`eeffr2::W`](W) writer structure"]
impl crate::Writable for Eeffr2Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets EEFFR2 to value 0"]
impl crate::Resettable for Eeffr2Spec {
