...
pub type R = crate::R<FltfrSpec>;
#[doc = "Register `FLTFR` writer"]
pub type W = crate::W<FltfrSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn flt1en(&mut self) -> Flt1enW<FltfrSpec> {
        Flt1enW::new(self, 0)
    }
    #[doc = "Bit 1 - Fault 2 enable"]
    #[inline(always)]
    #[must_use]
    pub fn flt2en(&mut self) -> Flt2enW<FltfrSpec> {
        Flt2enW::new(self, 1)
    }
    #[doc = "Bit 2 - Fault 3 enable"]
    #[inline(always)]
    #[must_use]
    pub fn flt3en(&mut self) -> Flt3enW<FltfrSpec> {
        Flt3enW::new(self, 2)
    }
    #[doc = "Bit 3 - Fault 4 enable"]
    #[inline(always)]
    #[must_use]
    pub fn flt4en(&mut self) -> Flt4enW<FltfrSpec> {
        Flt4enW::new(self, 3)
    }
    #[doc = "Bit 4 - Fault 5 enable"]
    #[inline(always)]
    #[must_use]
    pub fn flt5en(&mut self) -> Flt5enW<FltfrSpec> {
        Flt5enW::new(self, 4)
    }
    #[doc = "Bit 5 - Fault 6 enable"]
    #[inline(always)]
    #[must_use]
    pub fn flt6en(&mut self) -> Flt6enW<FltfrSpec> {
        Flt6enW::new(self, 5)
    }
    #[doc = "Bit 31 - Fault sources Lock"]
    #[inline(always)]
    #[must_use]
    pub fn fltlck(&mut self) -> FltlckW<FltfrSpec> {
        FltlckW::new(self, 31)
    }
}
#[doc = "Timerx Fault Register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`fltfr::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`fltfr::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct FltfrSpec;
impl crate::RegisterSpec for FltfrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`fltfr::R`](R) reader structure"]
impl crate::Readable for FltfrSpec {}
#[doc = "`write(|w| ..)` method takes [`fltfr::W`](W) writer structure"]
impl crate::Writable for FltfrSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets FLTFR to value 0"]
impl crate::Resettable for FltfrSpec {
