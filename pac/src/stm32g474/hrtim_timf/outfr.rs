...
pub type R = crate::R<OutfrSpec>;
#[doc = "Register `OUTFR` writer"]
pub type W = crate::W<OutfrSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pol1(&mut self) -> Pol1W<OutfrSpec> {
        Pol1W::new(self, 1)
    }
    #[doc = "Bit 2 - Output 1 Idle mode"]
    #[inline(always)]
    #[must_use]
    pub fn idlem1(&mut self) -> Idlem1W<OutfrSpec> {
        Idlem1W::new(self, 2)
    }
    #[doc = "Bit 3 - Output 1 Idle State"]
    #[inline(always)]
    #[must_use]
    pub fn idles1(&mut self) -> Idles1W<OutfrSpec> {
        Idles1W::new(self, 3)
    }
    #[doc = "Bits 4:5 - Output 1 Fault state"]
    #[inline(always)]
    #[must_use]
    pub fn fault1(&mut self) -> Fault1W<OutfrSpec> {
        Fault1W::new(self, 4)
    }
    #[doc = "Bit 6 - Output 1 Chopper enable"]
    #[inline(always)]
    #[must_use]
    pub fn chp1(&mut self) -> Chp1W<OutfrSpec> {
        Chp1W::new(self, 6)
    }
    #[doc = "Bit 7 - Output 1 Deadtime upon burst mode Idle entry"]
    #[inline(always)]
    #[must_use]
    pub fn didl1(&mut self) -> Didl1W<OutfrSpec> {
        Didl1W::new(self, 7)
    }
    #[doc = "Bit 8 - Deadtime enable"]
    #[inline(always)]
    #[must_use]
    pub fn dten(&mut self) -> DtenW<OutfrSpec> {
        DtenW::new(self, 8)
    }
    #[doc = "Bit 9 - Delayed Protection Enable"]
    #[inline(always)]
    #[must_use]
    pub fn dlyprten(&mut self) -> DlyprtenW<OutfrSpec> {
        DlyprtenW::new(self, 9)
    }
    #[doc = "Bits 10:12 - Delayed Protection"]
    #[inline(always)]
    #[must_use]
    pub fn dlyprt(&mut self) -> DlyprtW<OutfrSpec> {
        DlyprtW::new(self, 10)
    }
    #[doc = "Bit 14 - Balanced Idle Automatic Resume"]
    #[inline(always)]
    #[must_use]
    pub fn biar(&mut self) -> BiarW<OutfrSpec> {
        BiarW::new(self, 14)
    }
    #[doc = "Bit 17 - Output 2 polarity"]
    #[inline(always)]
    #[must_use]
    pub fn pol2(&mut self) -> Pol2W<OutfrSpec> {
        Pol2W::new(self, 17)
    }
    #[doc = "Bit 18 - Output 2 Idle mode"]
    #[inline(always)]
    #[must_use]
    pub fn idlem2(&mut self) -> Idlem2W<OutfrSpec> {
        Idlem2W::new(self, 18)
    }
    #[doc = "Bit 19 - Output 2 Idle State"]
    #[inline(always)]
    #[must_use]
    pub fn idles2(&mut self) -> Idles2W<OutfrSpec> {
        Idles2W::new(self, 19)
    }
    #[doc = "Bits 20:21 - Output 2 Fault state"]
    #[inline(always)]
    #[must_use]
    pub fn fault2(&mut self) -> Fault2W<OutfrSpec> {
        Fault2W::new(self, 20)
    }
    #[doc = "Bit 22 - Output 2 Chopper enable"]
    #[inline(always)]
    #[must_use]
    pub fn chp2(&mut self) -> Chp2W<OutfrSpec> {
        Chp2W::new(self, 22)
    }
    #[doc = "Bit 23 - Output 2 Deadtime upon burst mode Idle entry"]
    #[inline(always)]
    #[must_use]
    pub fn didl2(&mut self) -> Didl2W<OutfrSpec> {
        Didl2W::new(self, 23)
    }
}
...
pub struct OutfrSpec;
impl crate::RegisterSpec for OutfrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`outfr::R`](R) reader structure"]
impl crate::Readable for OutfrSpec {}
#[doc = "`write(|w| ..)` method takes [`outfr::W`](W) writer structure"]
impl crate::Writable for OutfrSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets OUTFR to value 0"]
impl crate::Resettable for OutfrSpec {
