...
pub type R = crate::R<Rstf2rSpec>;
#[doc = "Register `RSTF2R` writer"]
pub type W = crate::W<Rstf2rSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn srt(&mut self) -> SrtW<Rstf2rSpec> {
        SrtW::new(self, 0)
    }
    #[doc = "Bit 1 - RESYNC"]
    #[inline(always)]
    #[must_use]
    pub fn resync(&mut self) -> ResyncW<Rstf2rSpec> {
        ResyncW::new(self, 1)
    }
    #[doc = "Bit 2 - PER"]
    #[inline(always)]
    #[must_use]
    pub fn per(&mut self) -> PerW<Rstf2rSpec> {
        PerW::new(self, 2)
    }
    #[doc = "Bit 3 - CMP1"]
    #[inline(always)]
    #[must_use]
    pub fn cmp1(&mut self) -> Cmp1W<Rstf2rSpec> {
        Cmp1W::new(self, 3)
    }
    #[doc = "Bit 4 - CMP2"]
    #[inline(always)]
    #[must_use]
    pub fn cmp2(&mut self) -> Cmp2W<Rstf2rSpec> {
        Cmp2W::new(self, 4)
    }
    #[doc = "Bit 5 - CMP3"]
    #[inline(always)]
    #[must_use]
    pub fn cmp3(&mut self) -> Cmp3W<Rstf2rSpec> {
        Cmp3W::new(self, 5)
    }
    #[doc = "Bit 6 - CMP4"]
    #[inline(always)]
    #[must_use]
    pub fn cmp4(&mut self) -> Cmp4W<Rstf2rSpec> {
        Cmp4W::new(self, 6)
    }
    #[doc = "Bit 7 - MSTPER"]
    #[inline(always)]
    #[must_use]
    pub fn mstper(&mut self) -> MstperW<Rstf2rSpec> {
        MstperW::new(self, 7)
    }
    #[doc = "Bit 8 - MSTCMP1"]
    #[inline(always)]
    #[must_use]
    pub fn mstcmp1(&mut self) -> Mstcmp1W<Rstf2rSpec> {
        Mstcmp1W::new(self, 8)
    }
    #[doc = "Bit 9 - MSTCMP2"]
    #[inline(always)]
    #[must_use]
    pub fn mstcmp2(&mut self) -> Mstcmp2W<Rstf2rSpec> {
        Mstcmp2W::new(self, 9)
    }
    #[doc = "Bit 10 - MSTCMP3"]
    #[inline(always)]
    #[must_use]
    pub fn mstcmp3(&mut self) -> Mstcmp3W<Rstf2rSpec> {
        Mstcmp3W::new(self, 10)
    }
    #[doc = "Bit 11 - MSTCMP4"]
    #[inline(always)]
    #[must_use]
    pub fn mstcmp4(&mut self) -> Mstcmp4W<Rstf2rSpec> {
        Mstcmp4W::new(self, 11)
    }
    #[doc = "Bit 12 - TIMEVNT1"]
    #[inline(always)]
    #[must_use]
    pub fn timevnt1(&mut self) -> Timevnt1W<Rstf2rSpec> {
        Timevnt1W::new(self, 12)
    }
    #[doc = "Bit 13 - TIMEVNT2"]
    #[inline(always)]
    #[must_use]
    pub fn timevnt2(&mut self) -> Timevnt2W<Rstf2rSpec> {
        Timevnt2W::new(self, 13)
    }
    #[doc = "Bit 14 - TIMEVNT3"]
    #[inline(always)]
    #[must_use]
    pub fn timevnt3(&mut self) -> Timevnt3W<Rstf2rSpec> {
        Timevnt3W::new(self, 14)
    }
    #[doc = "Bit 15 - TIMEVNT4"]
    #[inline(always)]
    #[must_use]
    pub fn timevnt4(&mut self) -> Timevnt4W<Rstf2rSpec> {
        Timevnt4W::new(self, 15)
    }
    #[doc = "Bit 16 - TIMEVNT5"]
    #[inline(always)]
    #[must_use]
    pub fn timevnt5(&mut self) -> Timevnt5W<Rstf2rSpec> {
        Timevnt5W::new(self, 16)
    }
    #[doc = "Bit 17 - TIMEVNT6"]
    #[inline(always)]
    #[must_use]
    pub fn timevnt6(&mut self) -> Timevnt6W<Rstf2rSpec> {
        Timevnt6W::new(self, 17)
    }
    #[doc = "Bit 18 - TIMEVNT7"]
    #[inline(always)]
    #[must_use]
    pub fn timevnt7(&mut self) -> Timevnt7W<Rstf2rSpec> {
        Timevnt7W::new(self, 18)
    }
    #[doc = "Bit 19 - TIMEVNT8"]
    #[inline(always)]
    #[must_use]
    pub fn timevnt8(&mut self) -> Timevnt8W<Rstf2rSpec> {
        Timevnt8W::new(self, 19)
    }
    #[doc = "Bit 20 - TIMEVNT9"]
    #[inline(always)]
    #[must_use]
    pub fn timevnt9(&mut self) -> Timevnt9W<Rstf2rSpec> {
        Timevnt9W::new(self, 20)
    }
    #[doc = "Bit 21 - EXTEVNT1"]
    #[inline(always)]
    #[must_use]
    pub fn extevnt1(&mut self) -> Extevnt1W<Rstf2rSpec> {
        Extevnt1W::new(self, 21)
    }
    #[doc = "Bit 22 - EXTEVNT2"]
    #[inline(always)]
    #[must_use]
    pub fn extevnt2(&mut self) -> Extevnt2W<Rstf2rSpec> {
        Extevnt2W::new(self, 22)
    }
    #[doc = "Bit 23 - EXTEVNT3"]
    #[inline(always)]
    #[must_use]
    pub fn extevnt3(&mut self) -> Extevnt3W<Rstf2rSpec> {
        Extevnt3W::new(self, 23)
    }
    #[doc = "Bit 24 - EXTEVNT4"]
    #[inline(always)]
    #[must_use]
    pub fn extevnt4(&mut self) -> Extevnt4W<Rstf2rSpec> {
        Extevnt4W::new(self, 24)
    }
    #[doc = "Bit 25 - EXTEVNT5"]
    #[inline(always)]
    #[must_use]
    pub fn extevnt5(&mut self) -> Extevnt5W<Rstf2rSpec> {
        Extevnt5W::new(self, 25)
    }
    #[doc = "Bit 26 - EXTEVNT6"]
    #[inline(always)]
    #[must_use]
    pub fn extevnt6(&mut self) -> Extevnt6W<Rstf2rSpec> {
        Extevnt6W::new(self, 26)
    }
    #[doc = "Bit 27 - EXTEVNT7"]
    #[inline(always)]
    #[must_use]
    pub fn extevnt7(&mut self) -> Extevnt7W<Rstf2rSpec> {
        Extevnt7W::new(self, 27)
    }
    #[doc = "Bit 28 - EXTEVNT8"]
    #[inline(always)]
    #[must_use]
    pub fn extevnt8(&mut self) -> Extevnt8W<Rstf2rSpec> {
        Extevnt8W::new(self, 28)
    }
    #[doc = "Bit 29 - EXTEVNT9"]
    #[inline(always)]
    #[must_use]
    pub fn extevnt9(&mut self) -> Extevnt9W<Rstf2rSpec> {
        Extevnt9W::new(self, 29)
    }
    #[doc = "Bit 30 - EXTEVNT10"]
    #[inline(always)]
    #[must_use]
    pub fn extevnt10(&mut self) -> Extevnt10W<Rstf2rSpec> {
        Extevnt10W::new(self, 30)
    }
    #[doc = "Bit 31 - UPDATE"]
    #[inline(always)]
    #[must_use]
    pub fn update(&mut self) -> UpdateW<Rstf2rSpec> {
        UpdateW::new(self, 31)
    }
}
...
pub struct Rstf2rSpec;
impl crate::RegisterSpec for Rstf2rSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`rstf2r::R`](R) reader structure"]
impl crate::Readable for Rstf2rSpec {}
#[doc = "`write(|w| ..)` method takes [`rstf2r::W`](W) writer structure"]
impl crate::Writable for Rstf2rSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets RSTF2R to value 0"]
impl crate::Resettable for Rstf2rSpec {
