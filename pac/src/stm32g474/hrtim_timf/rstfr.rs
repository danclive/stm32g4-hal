...
pub type R = crate::R<RstfrSpec>;
#[doc = "Register `RSTFR` writer"]
pub type W = crate::W<RstfrSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn timfcmp1(&mut self) -> Timfcmp1W<RstfrSpec> {
        Timfcmp1W::new(self, 0)
    }
    #[doc = "Bit 1 - Timer A Update reset"]
    #[inline(always)]
    #[must_use]
    pub fn updt(&mut self) -> UpdtW<RstfrSpec> {
        UpdtW::new(self, 1)
    }
    #[doc = "Bit 2 - Timer A compare 2 reset"]
    #[inline(always)]
    #[must_use]
    pub fn cmp2(&mut self) -> Cmp2W<RstfrSpec> {
        Cmp2W::new(self, 2)
    }
    #[doc = "Bit 3 - Timer A compare 4 reset"]
    #[inline(always)]
    #[must_use]
    pub fn cmp4(&mut self) -> Cmp4W<RstfrSpec> {
        Cmp4W::new(self, 3)
    }
    #[doc = "Bit 4 - Master timer Period"]
    #[inline(always)]
    #[must_use]
    pub fn mstper(&mut self) -> MstperW<RstfrSpec> {
        MstperW::new(self, 4)
    }
    #[doc = "Bit 5 - Master compare 1"]
    #[inline(always)]
    #[must_use]
    pub fn mstcmp1(&mut self) -> Mstcmp1W<RstfrSpec> {
        Mstcmp1W::new(self, 5)
    }
    #[doc = "Bit 6 - Master compare 2"]
    #[inline(always)]
    #[must_use]
    pub fn mstcmp2(&mut self) -> Mstcmp2W<RstfrSpec> {
        Mstcmp2W::new(self, 6)
    }
    #[doc = "Bit 7 - Master compare 3"]
    #[inline(always)]
    #[must_use]
    pub fn mstcmp3(&mut self) -> Mstcmp3W<RstfrSpec> {
        Mstcmp3W::new(self, 7)
    }
    #[doc = "Bit 8 - Master compare 4"]
    #[inline(always)]
    #[must_use]
    pub fn mstcmp4(&mut self) -> Mstcmp4W<RstfrSpec> {
        Mstcmp4W::new(self, 8)
    }
    #[doc = "Bit 9 - External Event 1"]
    #[inline(always)]
    #[must_use]
    pub fn extevnt1(&mut self) -> Extevnt1W<RstfrSpec> {
        Extevnt1W::new(self, 9)
    }
    #[doc = "Bit 10 - External Event 2"]
    #[inline(always)]
    #[must_use]
    pub fn extevnt2(&mut self) -> Extevnt2W<RstfrSpec> {
        Extevnt2W::new(self, 10)
    }
    #[doc = "Bit 11 - External Event 3"]
    #[inline(always)]
    #[must_use]
    pub fn extevnt3(&mut self) -> Extevnt3W<RstfrSpec> {
        Extevnt3W::new(self, 11)
    }
    #[doc = "Bit 12 - External Event 4"]
    #[inline(always)]
    #[must_use]
    pub fn extevnt4(&mut self) -> Extevnt4W<RstfrSpec> {
        Extevnt4W::new(self, 12)
    }
    #[doc = "Bit 13 - External Event 5"]
    #[inline(always)]
    #[must_use]
    pub fn extevnt5(&mut self) -> Extevnt5W<RstfrSpec> {
        Extevnt5W::new(self, 13)
    }
    #[doc = "Bit 14 - External Event 6"]
    #[inline(always)]
    #[must_use]
    pub fn extevnt6(&mut self) -> Extevnt6W<RstfrSpec> {
        Extevnt6W::new(self, 14)
    }
    #[doc = "Bit 15 - External Event 7"]
    #[inline(always)]
    #[must_use]
    pub fn extevnt7(&mut self) -> Extevnt7W<RstfrSpec> {
        Extevnt7W::new(self, 15)
    }
    #[doc = "Bit 16 - External Event 8"]
    #[inline(always)]
    #[must_use]
    pub fn extevnt8(&mut self) -> Extevnt8W<RstfrSpec> {
        Extevnt8W::new(self, 16)
    }
    #[doc = "Bit 17 - External Event 9"]
    #[inline(always)]
    #[must_use]
    pub fn extevnt9(&mut self) -> Extevnt9W<RstfrSpec> {
        Extevnt9W::new(self, 17)
    }
    #[doc = "Bit 18 - External Event 10"]
    #[inline(always)]
    #[must_use]
    pub fn extevnt10(&mut self) -> Extevnt10W<RstfrSpec> {
        Extevnt10W::new(self, 18)
    }
    #[doc = "Bit 19 - Timer A Compare 1"]
    #[inline(always)]
    #[must_use]
    pub fn timacmp1(&mut self) -> Timacmp1W<RstfrSpec> {
        Timacmp1W::new(self, 19)
    }
    #[doc = "Bit 20 - Timer A Compare 2"]
    #[inline(always)]
    #[must_use]
    pub fn timacmp2(&mut self) -> Timacmp2W<RstfrSpec> {
        Timacmp2W::new(self, 20)
    }
    #[doc = "Bit 21 - Timer A Compare 4"]
    #[inline(always)]
    #[must_use]
    pub fn timacmp4(&mut self) -> Timacmp4W<RstfrSpec> {
        Timacmp4W::new(self, 21)
    }
    #[doc = "Bit 22 - Timer B Compare 1"]
    #[inline(always)]
    #[must_use]
    pub fn timbcmp1(&mut self) -> Timbcmp1W<RstfrSpec> {
        Timbcmp1W::new(self, 22)
    }
    #[doc = "Bit 23 - Timer B Compare 2"]
    #[inline(always)]
    #[must_use]
    pub fn timbcmp2(&mut self) -> Timbcmp2W<RstfrSpec> {
        Timbcmp2W::new(self, 23)
    }
    #[doc = "Bit 24 - Timer B Compare 4"]
    #[inline(always)]
    #[must_use]
    pub fn timbcmp4(&mut self) -> Timbcmp4W<RstfrSpec> {
        Timbcmp4W::new(self, 24)
    }
    #[doc = "Bit 25 - Timer C Compare 1"]
    #[inline(always)]
    #[must_use]
    pub fn timccmp1(&mut self) -> Timccmp1W<RstfrSpec> {
        Timccmp1W::new(self, 25)
    }
    #[doc = "Bit 26 - Timer C Compare 2"]
    #[inline(always)]
    #[must_use]
    pub fn timccmp2(&mut self) -> Timccmp2W<RstfrSpec> {
        Timccmp2W::new(self, 26)
    }
    #[doc = "Bit 27 - Timer C Compare 4"]
    #[inline(always)]
    #[must_use]
    pub fn timccmp4(&mut self) -> Timccmp4W<RstfrSpec> {
        Timccmp4W::new(self, 27)
    }
    #[doc = "Bit 28 - Timer D Compare 1"]
    #[inline(always)]
    #[must_use]
    pub fn timdcmp1(&mut self) -> Timdcmp1W<RstfrSpec> {
        Timdcmp1W::new(self, 28)
    }
    #[doc = "Bit 29 - Timer D Compare 2"]
    #[inline(always)]
    #[must_use]
    pub fn timdcmp2(&mut self) -> Timdcmp2W<RstfrSpec> {
        Timdcmp2W::new(self, 29)
    }
    #[doc = "Bit 30 - Timer D Compare 4"]
    #[inline(always)]
    #[must_use]
    pub fn timdcmp4(&mut self) -> Timdcmp4W<RstfrSpec> {
        Timdcmp4W::new(self, 30)
    }
    #[doc = "Bit 31 - Timer F Compare 2"]
    #[inline(always)]
    #[must_use]
    pub fn timfcpm2(&mut self) -> Timfcpm2W<RstfrSpec> {
...
pub struct RstfrSpec;
impl crate::RegisterSpec for RstfrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`rstfr::R`](R) reader structure"]
impl crate::Readable for RstfrSpec {}
#[doc = "`write(|w| ..)` method takes [`rstfr::W`](W) writer structure"]
impl crate::Writable for RstfrSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets RSTFR to value 0"]
impl crate::Resettable for RstfrSpec {
