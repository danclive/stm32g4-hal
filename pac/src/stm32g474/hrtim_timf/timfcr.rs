...
pub type R = crate::R<TimfcrSpec>;
#[doc = "Register `TIMFCR` writer"]
pub type W = crate::W<TimfcrSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ck_pscx(&mut self) -> CkPscxW<TimfcrSpec> {
        CkPscxW::new(self, 0)
    }
    #[doc = "Bit 3 - Continuous mode"]
    #[inline(always)]
    #[must_use]
    pub fn cont(&mut self) -> ContW<TimfcrSpec> {
        ContW::new(self, 3)
    }
    #[doc = "Bit 4 - Re-triggerable mode"]
    #[inline(always)]
    #[must_use]
    pub fn retrig(&mut self) -> RetrigW<TimfcrSpec> {
        RetrigW::new(self, 4)
    }
    #[doc = "Bit 5 - Half mode enable"]
    #[inline(always)]
    #[must_use]
    pub fn half(&mut self) -> HalfW<TimfcrSpec> {
        HalfW::new(self, 5)
    }
    #[doc = "Bit 6 - Push-Pull mode enable"]
    #[inline(always)]
    #[must_use]
    pub fn pshpll(&mut self) -> PshpllW<TimfcrSpec> {
        PshpllW::new(self, 6)
    }
    #[doc = "Bits 7:8 - Interleaved mode"]
    #[inline(always)]
    #[must_use]
    pub fn intlvd(&mut self) -> IntlvdW<TimfcrSpec> {
        IntlvdW::new(self, 7)
    }
    #[doc = "Bit 9 - Re-Synchronized Update"]
    #[inline(always)]
    #[must_use]
    pub fn rsyncu(&mut self) -> RsyncuW<TimfcrSpec> {
        RsyncuW::new(self, 9)
    }
    #[doc = "Bit 10 - Synchronization Resets Timer x"]
    #[inline(always)]
    #[must_use]
    pub fn syncrstx(&mut self) -> SyncrstxW<TimfcrSpec> {
        SyncrstxW::new(self, 10)
    }
    #[doc = "Bit 11 - Synchronization Starts Timer x"]
    #[inline(always)]
    #[must_use]
    pub fn syncstrtx(&mut self) -> SyncstrtxW<TimfcrSpec> {
        SyncstrtxW::new(self, 11)
    }
    #[doc = "Bits 12:13 - Delayed CMP2 mode"]
    #[inline(always)]
    #[must_use]
    pub fn delcmp2(&mut self) -> Delcmp2W<TimfcrSpec> {
        Delcmp2W::new(self, 12)
    }
    #[doc = "Bits 14:15 - Delayed CMP4 mode"]
    #[inline(always)]
    #[must_use]
    pub fn delcmp4(&mut self) -> Delcmp4W<TimfcrSpec> {
        Delcmp4W::new(self, 14)
    }
    #[doc = "Bit 17 - Timer x Repetition update"]
    #[inline(always)]
    #[must_use]
    pub fn tx_repu(&mut self) -> TxRepuW<TimfcrSpec> {
        TxRepuW::new(self, 17)
    }
    #[doc = "Bit 18 - Timerx reset update"]
    #[inline(always)]
    #[must_use]
    pub fn tx_rstu(&mut self) -> TxRstuW<TimfcrSpec> {
        TxRstuW::new(self, 18)
    }
    #[doc = "Bit 19 - TAU"]
    #[inline(always)]
    #[must_use]
    pub fn tau(&mut self) -> TauW<TimfcrSpec> {
        TauW::new(self, 19)
    }
    #[doc = "Bit 20 - TBU"]
    #[inline(always)]
    #[must_use]
    pub fn tbu(&mut self) -> TbuW<TimfcrSpec> {
        TbuW::new(self, 20)
    }
    #[doc = "Bit 21 - TCU"]
    #[inline(always)]
    #[must_use]
    pub fn tcu(&mut self) -> TcuW<TimfcrSpec> {
        TcuW::new(self, 21)
    }
    #[doc = "Bit 22 - TDU"]
    #[inline(always)]
    #[must_use]
    pub fn tdu(&mut self) -> TduW<TimfcrSpec> {
        TduW::new(self, 22)
    }
    #[doc = "Bit 24 - Master Timer update"]
    #[inline(always)]
    #[must_use]
    pub fn mstu(&mut self) -> MstuW<TimfcrSpec> {
        MstuW::new(self, 24)
    }
    #[doc = "Bits 25:26 - AC Synchronization"]
    #[inline(always)]
    #[must_use]
    pub fn dacsync(&mut self) -> DacsyncW<TimfcrSpec> {
        DacsyncW::new(self, 25)
    }
    #[doc = "Bit 27 - Preload enable"]
    #[inline(always)]
    #[must_use]
    pub fn preen(&mut self) -> PreenW<TimfcrSpec> {
        PreenW::new(self, 27)
    }
    #[doc = "Bits 28:31 - Update Gating"]
    #[inline(always)]
    #[must_use]
    pub fn updgat(&mut self) -> UpdgatW<TimfcrSpec> {
        UpdgatW::new(self, 28)
    }
}
#[doc = "Timerx Control Register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`timfcr::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`timfcr::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct TimfcrSpec;
impl crate::RegisterSpec for TimfcrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`timfcr::R`](R) reader structure"]
impl crate::Readable for TimfcrSpec {}
#[doc = "`write(|w| ..)` method takes [`timfcr::W`](W) writer structure"]
impl crate::Writable for TimfcrSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets TIMFCR to value 0"]
impl crate::Resettable for TimfcrSpec {
