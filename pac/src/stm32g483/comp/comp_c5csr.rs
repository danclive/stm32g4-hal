...
pub type R = crate::R<CompC5csrSpec>;
#[doc = "Register `COMP_C5CSR` writer"]
pub type W = crate::W<CompC5csrSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn en(&mut self) -> EnW<CompC5csrSpec> {
        EnW::new(self, 0)
    }
    #[doc = "Bits 4:6 - INMSEL"]
    #[inline(always)]
    #[must_use]
    pub fn inmsel(&mut self) -> InmselW<CompC5csrSpec> {
        InmselW::new(self, 4)
    }
    #[doc = "Bit 8 - INPSEL"]
    #[inline(always)]
    #[must_use]
    pub fn inpsel(&mut self) -> InpselW<CompC5csrSpec> {
        InpselW::new(self, 8)
    }
    #[doc = "Bit 15 - POL"]
    #[inline(always)]
    #[must_use]
    pub fn pol(&mut self) -> PolW<CompC5csrSpec> {
        PolW::new(self, 15)
    }
    #[doc = "Bits 16:18 - HYST"]
    #[inline(always)]
    #[must_use]
    pub fn hyst(&mut self) -> HystW<CompC5csrSpec> {
        HystW::new(self, 16)
    }
    #[doc = "Bits 19:21 - BLANKSEL"]
    #[inline(always)]
    #[must_use]
    pub fn blanksel(&mut self) -> BlankselW<CompC5csrSpec> {
        BlankselW::new(self, 19)
    }
    #[doc = "Bit 22 - BRGEN"]
    #[inline(always)]
    #[must_use]
    pub fn brgen(&mut self) -> BrgenW<CompC5csrSpec> {
        BrgenW::new(self, 22)
    }
    #[doc = "Bit 23 - SCALEN"]
    #[inline(always)]
    #[must_use]
    pub fn scalen(&mut self) -> ScalenW<CompC5csrSpec> {
        ScalenW::new(self, 23)
    }
    #[doc = "Bit 31 - LOCK"]
    #[inline(always)]
    #[must_use]
    pub fn lock(&mut self) -> LockW<CompC5csrSpec> {
        LockW::new(self, 31)
    }
}
#[doc = "Comparator control/status register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`comp_c5csr::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`comp_c5csr::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct CompC5csrSpec;
impl crate::RegisterSpec for CompC5csrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`comp_c5csr::R`](R) reader structure"]
impl crate::Readable for CompC5csrSpec {}
#[doc = "`write(|w| ..)` method takes [`comp_c5csr::W`](W) writer structure"]
impl crate::Writable for CompC5csrSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets COMP_C5CSR to value 0"]
impl crate::Resettable for CompC5csrSpec {
