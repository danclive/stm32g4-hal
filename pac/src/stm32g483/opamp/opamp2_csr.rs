...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn opaintoen(&mut self) -> OpaintoenW<Opamp2CsrSpec> {
    ...
    #[inline(always)]
    #[must_use]
    pub fn trimoffsetp(&mut self) -> TrimoffsetpW<Opamp2CsrSpec> {
        TrimoffsetpW::new(self, 19)
    }
    #[doc = "Bits 24:28 - TRIMOFFSETN"]
    #[inline(always)]
    #[must_use]
    pub fn trimoffsetn(&mut self) -> TrimoffsetnW<Opamp2CsrSpec> {
    ...
    #[inline(always)]
    #[must_use]
    pub fn lock(&mut self) -> LockW<Opamp2CsrSpec> {
        LockW::new(self, 31)
    }
}
