...
pub type R = crate::R<Opamp5TcmrSpec>;
#[doc = "Register `OPAMP5_TCMR` writer"]
pub type W = crate::W<Opamp5TcmrSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn vms_sel(&mut self) -> VmsSelW<Opamp5TcmrSpec> {
        VmsSelW::new(self, 0)
    }
    #[doc = "Bits 1:2 - VPS_SEL"]
    #[inline(always)]
    #[must_use]
    pub fn vps_sel(&mut self) -> VpsSelW<Opamp5TcmrSpec> {
        VpsSelW::new(self, 1)
    }
    #[doc = "Bit 3 - T1CM_EN"]
    #[inline(always)]
    #[must_use]
    pub fn t1cm_en(&mut self) -> T1cmEnW<Opamp5TcmrSpec> {
        T1cmEnW::new(self, 3)
    }
    #[doc = "Bit 4 - T8CM_EN"]
    #[inline(always)]
    #[must_use]
    pub fn t8cm_en(&mut self) -> T8cmEnW<Opamp5TcmrSpec> {
        T8cmEnW::new(self, 4)
    }
    #[doc = "Bit 5 - T20CM_EN"]
    #[inline(always)]
    #[must_use]
    pub fn t20cm_en(&mut self) -> T20cmEnW<Opamp5TcmrSpec> {
        T20cmEnW::new(self, 5)
    }
    #[doc = "Bit 31 - LOCK"]
    #[inline(always)]
    #[must_use]
    pub fn lock(&mut self) -> LockW<Opamp5TcmrSpec> {
        LockW::new(self, 31)
    }
}
...
pub struct Opamp5TcmrSpec;
impl crate::RegisterSpec for Opamp5TcmrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`opamp5_tcmr::R`](R) reader structure"]
impl crate::Readable for Opamp5TcmrSpec {}
#[doc = "`write(|w| ..)` method takes [`opamp5_tcmr::W`](W) writer structure"]
impl crate::Writable for Opamp5TcmrSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets OPAMP5_TCMR to value 0"]
impl crate::Resettable for Opamp5TcmrSpec {
