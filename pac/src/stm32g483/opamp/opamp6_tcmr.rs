...
pub type R = crate::R<Opamp6TcmrSpec>;
#[doc = "Register `OPAMP6_TCMR` writer"]
pub type W = crate::W<Opamp6TcmrSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn vms_sel(&mut self) -> VmsSelW<Opamp6TcmrSpec> {
        VmsSelW::new(self, 0)
    }
    #[doc = "Bits 1:2 - VPS_SEL"]
    #[inline(always)]
    #[must_use]
    pub fn vps_sel(&mut self) -> VpsSelW<Opamp6TcmrSpec> {
        VpsSelW::new(self, 1)
    }
    #[doc = "Bit 3 - T1CM_EN"]
    #[inline(always)]
    #[must_use]
    pub fn t1cm_en(&mut self) -> T1cmEnW<Opamp6TcmrSpec> {
        T1cmEnW::new(self, 3)
    }
    #[doc = "Bit 4 - T8CM_EN"]
    #[inline(always)]
    #[must_use]
    pub fn t8cm_en(&mut self) -> T8cmEnW<Opamp6TcmrSpec> {
        T8cmEnW::new(self, 4)
    }
    #[doc = "Bit 5 - T20CM_EN"]
    #[inline(always)]
    #[must_use]
    pub fn t20cm_en(&mut self) -> T20cmEnW<Opamp6TcmrSpec> {
        T20cmEnW::new(self, 5)
    }
    #[doc = "Bit 31 - LOCK"]
    #[inline(always)]
    #[must_use]
    pub fn lock(&mut self) -> LockW<Opamp6TcmrSpec> {
        LockW::new(self, 31)
    }
}
#[doc = "OPAMP6 control/status register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`opamp6_tcmr::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`opamp6_tcmr::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Opamp6TcmrSpec;
impl crate::RegisterSpec for Opamp6TcmrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`opamp6_tcmr::R`](R) reader structure"]
impl crate::Readable for Opamp6TcmrSpec {}
#[doc = "`write(|w| ..)` method takes [`opamp6_tcmr::W`](W) writer structure"]
impl crate::Writable for Opamp6TcmrSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets OPAMP6_TCMR to value 0"]
impl crate::Resettable for Opamp6TcmrSpec {
