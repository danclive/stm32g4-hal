...
pub type R = crate::R<BdtauprSpec>;
#[doc = "Register `BDTAUPR` writer"]
pub type W = crate::W<BdtauprSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn timx_cr(&mut self) -> TimxCrW<BdtauprSpec> {
        TimxCrW::new(self, 0)
    }
    #[doc = "Bit 1 - HRTIM_TIMxICR register update enable"]
    #[inline(always)]
    #[must_use]
    pub fn timx_icr(&mut self) -> TimxIcrW<BdtauprSpec> {
        TimxIcrW::new(self, 1)
    }
    #[doc = "Bit 2 - HRTIM_TIMxDIER register update enable"]
    #[inline(always)]
    #[must_use]
    pub fn timx_dier(&mut self) -> TimxDierW<BdtauprSpec> {
        TimxDierW::new(self, 2)
    }
    #[doc = "Bit 3 - HRTIM_CNTxR register update enable"]
    #[inline(always)]
    #[must_use]
    pub fn timx_cnt(&mut self) -> TimxCntW<BdtauprSpec> {
        TimxCntW::new(self, 3)
    }
    #[doc = "Bit 4 - HRTIM_PERxR register update enable"]
    #[inline(always)]
    #[must_use]
    pub fn timx_per(&mut self) -> TimxPerW<BdtauprSpec> {
        TimxPerW::new(self, 4)
    }
    #[doc = "Bit 5 - HRTIM_REPxR register update enable"]
    #[inline(always)]
    #[must_use]
    pub fn timx_rep(&mut self) -> TimxRepW<BdtauprSpec> {
        TimxRepW::new(self, 5)
    }
    #[doc = "Bit 6 - HRTIM_CMP1xR register update enable"]
    #[inline(always)]
    #[must_use]
    pub fn timx_cmp1(&mut self) -> TimxCmp1W<BdtauprSpec> {
        TimxCmp1W::new(self, 6)
    }
    #[doc = "Bit 7 - HRTIM_CMP2xR register update enable"]
    #[inline(always)]
    #[must_use]
    pub fn timx_cmp2(&mut self) -> TimxCmp2W<BdtauprSpec> {
        TimxCmp2W::new(self, 7)
    }
    #[doc = "Bit 8 - HRTIM_CMP3xR register update enable"]
    #[inline(always)]
    #[must_use]
    pub fn timx_cmp3(&mut self) -> TimxCmp3W<BdtauprSpec> {
        TimxCmp3W::new(self, 8)
    }
    #[doc = "Bit 9 - HRTIM_CMP4xR register update enable"]
    #[inline(always)]
    #[must_use]
    pub fn timx_cmp4(&mut self) -> TimxCmp4W<BdtauprSpec> {
        TimxCmp4W::new(self, 9)
    }
    #[doc = "Bit 10 - HRTIM_DTxR register update enable"]
    #[inline(always)]
    #[must_use]
    pub fn timx_dtx_r(&mut self) -> TimxDtxRW<BdtauprSpec> {
        TimxDtxRW::new(self, 10)
    }
    #[doc = "Bit 11 - HRTIM_SET1xR register update enable"]
    #[inline(always)]
    #[must_use]
    pub fn timx_set1r(&mut self) -> TimxSet1rW<BdtauprSpec> {
        TimxSet1rW::new(self, 11)
    }
    #[doc = "Bit 12 - HRTIM_RST1xR register update enable"]
    #[inline(always)]
    #[must_use]
    pub fn timx_rst1r(&mut self) -> TimxRst1rW<BdtauprSpec> {
        TimxRst1rW::new(self, 12)
    }
    #[doc = "Bit 13 - HRTIM_SET2xR register update enable"]
    #[inline(always)]
    #[must_use]
    pub fn timx_set2r(&mut self) -> TimxSet2rW<BdtauprSpec> {
        TimxSet2rW::new(self, 13)
    }
    #[doc = "Bit 14 - HRTIM_RST2xR register update enable"]
    #[inline(always)]
    #[must_use]
    pub fn timx_rst2r(&mut self) -> TimxRst2rW<BdtauprSpec> {
        TimxRst2rW::new(self, 14)
    }
    #[doc = "Bit 15 - HRTIM_EEFxR1 register update enable"]
    #[inline(always)]
    #[must_use]
    pub fn timx_eefr1(&mut self) -> TimxEefr1W<BdtauprSpec> {
        TimxEefr1W::new(self, 15)
    }
    #[doc = "Bit 16 - HRTIM_EEFxR2 register update enable"]
    #[inline(always)]
    #[must_use]
    pub fn timx_eefr2(&mut self) -> TimxEefr2W<BdtauprSpec> {
        TimxEefr2W::new(self, 16)
    }
    #[doc = "Bit 17 - HRTIM_RSTxR register update enable"]
    #[inline(always)]
    #[must_use]
    pub fn timx_rstr(&mut self) -> TimxRstrW<BdtauprSpec> {
        TimxRstrW::new(self, 17)
    }
    #[doc = "Bit 18 - HRTIM_CHPxR register update enable"]
    #[inline(always)]
    #[must_use]
    pub fn timx_chpr(&mut self) -> TimxChprW<BdtauprSpec> {
        TimxChprW::new(self, 18)
    }
    #[doc = "Bit 19 - HRTIM_OUTxR register update enable"]
    #[inline(always)]
    #[must_use]
    pub fn timx_outr(&mut self) -> TimxOutrW<BdtauprSpec> {
        TimxOutrW::new(self, 19)
    }
    #[doc = "Bit 20 - HRTIM_FLTxR register update enable"]
    #[inline(always)]
    #[must_use]
    pub fn timx_fltr(&mut self) -> TimxFltrW<BdtauprSpec> {
        TimxFltrW::new(self, 20)
    }
    #[doc = "Bit 21 - TIMxCR2"]
    #[inline(always)]
    #[must_use]
    pub fn timx_cr2(&mut self) -> TimxCr2W<BdtauprSpec> {
        TimxCr2W::new(self, 21)
    }
    #[doc = "Bit 22 - TIMxEEFR3"]
    #[inline(always)]
    #[must_use]
    pub fn timx_eefr3(&mut self) -> TimxEefr3W<BdtauprSpec> {
...
pub struct BdtauprSpec;
impl crate::RegisterSpec for BdtauprSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`bdtaupr::R`](R) reader structure"]
impl crate::Readable for BdtauprSpec {}
#[doc = "`write(|w| ..)` method takes [`bdtaupr::W`](W) writer structure"]
impl crate::Writable for BdtauprSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets BDTAUPR to value 0"]
impl crate::Resettable for BdtauprSpec {
