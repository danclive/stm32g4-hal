...
pub type R = crate::R<Timacr2Spec>;
#[doc = "Register `TIMACR2` writer"]
pub type W = crate::W<Timacr2Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dcde(&mut self) -> DcdeW<Timacr2Spec> {
        DcdeW::new(self, 0)
    }
    #[doc = "Bit 1 - Dual Channel DAC Step trigger"]
    #[inline(always)]
    #[must_use]
    pub fn dcds(&mut self) -> DcdsW<Timacr2Spec> {
        DcdsW::new(self, 1)
    }
    #[doc = "Bit 2 - Dual Channel DAC Reset trigger"]
    #[inline(always)]
    #[must_use]
    pub fn dcdr(&mut self) -> DcdrW<Timacr2Spec> {
        DcdrW::new(self, 2)
    }
    #[doc = "Bit 4 - Up-Down Mode"]
    #[inline(always)]
    #[must_use]
    pub fn udm(&mut self) -> UdmW<Timacr2Spec> {
        UdmW::new(self, 4)
    }
    #[doc = "Bits 6:7 - Roll-Over Mode"]
    #[inline(always)]
    #[must_use]
    pub fn rom(&mut self) -> RomW<Timacr2Spec> {
        RomW::new(self, 6)
    }
    #[doc = "Bits 8:9 - Output Roll-Over Mode"]
    #[inline(always)]
    #[must_use]
    pub fn outrom(&mut self) -> OutromW<Timacr2Spec> {
        OutromW::new(self, 8)
    }
    #[doc = "Bits 10:11 - ADC Roll-Over Mode"]
    #[inline(always)]
    #[must_use]
    pub fn adrom(&mut self) -> AdromW<Timacr2Spec> {
        AdromW::new(self, 10)
    }
    #[doc = "Bits 12:13 - Burst Mode Roll-Over Mode"]
    #[inline(always)]
    #[must_use]
    pub fn bmrom(&mut self) -> BmromW<Timacr2Spec> {
        BmromW::new(self, 12)
    }
    #[doc = "Bits 14:15 - Fault and Event Roll-Over Mode"]
    #[inline(always)]
    #[must_use]
    pub fn ferom(&mut self) -> FeromW<Timacr2Spec> {
        FeromW::new(self, 14)
    }
    #[doc = "Bit 16 - Greater than Compare 1 PWM mode"]
    #[inline(always)]
    #[must_use]
    pub fn gtcmp1(&mut self) -> Gtcmp1W<Timacr2Spec> {
        Gtcmp1W::new(self, 16)
    }
    #[doc = "Bit 17 - Greater than Compare 3 PWM mode"]
    #[inline(always)]
    #[must_use]
    pub fn gtcmp3(&mut self) -> Gtcmp3W<Timacr2Spec> {
        Gtcmp3W::new(self, 17)
    }
    #[doc = "Bit 20 - Triggered-half mode"]
    #[inline(always)]
    #[must_use]
    pub fn trghlf(&mut self) -> TrghlfW<Timacr2Spec> {
        TrghlfW::new(self, 20)
    }
}
#[doc = "HRTIM Timerx Control Register 2\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`timacr2::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`timacr2::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Timacr2Spec;
impl crate::RegisterSpec for Timacr2Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`timacr2::R`](R) reader structure"]
impl crate::Readable for Timacr2Spec {}
#[doc = "`write(|w| ..)` method takes [`timacr2::W`](W) writer structure"]
impl crate::Writable for Timacr2Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets TIMACR2 to value 0"]
impl crate::Resettable for Timacr2Spec {
