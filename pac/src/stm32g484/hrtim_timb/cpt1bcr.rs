...
impl R {
    ...
    pub fn tf1set(&self) -> Tf1setR {
        Tf1setR::new(((self.bits >> 16) & 1) != 0)
    }
    #[doc = "Bit 17 - TF1RST"]
    #[inline(always)]
    pub fn tf1rst(&self) -> Tf1rstR {
        Tf1rstR::new(((self.bits >> 17) & 1) != 0)
    }
    #[doc = "Bit 18 - TFCMP1"]
    #[inline(always)]
    pub fn tfcmp1(&self) -> Tfcmp1R {
        Tfcmp1R::new(((self.bits >> 18) & 1) != 0)
    }
    #[doc = "Bit 19 - TFCMP2"]
    #[inline(always)]
    pub fn tfcmp2(&self) -> Tfcmp2R {
        Tfcmp2R::new(((self.bits >> 19) & 1) != 0)
    }
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tf1set(&mut self) -> Tf1setW<Cpt1bcrSpec> {
        Tf1setW::new(self, 16)
    }
    #[doc = "Bit 17 - TF1RST"]
    #[inline(always)]
    #[must_use]
    pub fn tf1rst(&mut self) -> Tf1rstW<Cpt1bcrSpec> {
        Tf1rstW::new(self, 17)
    }
    #[doc = "Bit 18 - TFCMP1"]
    #[inline(always)]
    #[must_use]
    pub fn tfcmp1(&mut self) -> Tfcmp1W<Cpt1bcrSpec> {
        Tfcmp1W::new(self, 18)
    }
    #[doc = "Bit 19 - TFCMP2"]
    #[inline(always)]
    #[must_use]
    pub fn tfcmp2(&mut self) -> Tfcmp2W<Cpt1bcrSpec> {
        Tfcmp2W::new(self, 19)
    }
    #[doc = "Bit 20 - Timer C output 1 Set"]
    #[inline(always)]
