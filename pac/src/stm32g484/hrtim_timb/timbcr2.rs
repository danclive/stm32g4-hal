...
pub type R = crate::R<Timbcr2Spec>;
#[doc = "Register `TIMBCR2` writer"]
pub type W = crate::W<Timbcr2Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dcde(&mut self) -> DcdeW<Timbcr2Spec> {
        DcdeW::new(self, 0)
    }
    #[doc = "Bit 1 - Dual Channel DAC Step trigger"]
    #[inline(always)]
    #[must_use]
    pub fn dcds(&mut self) -> DcdsW<Timbcr2Spec> {
        DcdsW::new(self, 1)
    }
    #[doc = "Bit 2 - Dual Channel DAC Reset trigger"]
    #[inline(always)]
    #[must_use]
    pub fn dcdr(&mut self) -> DcdrW<Timbcr2Spec> {
        DcdrW::new(self, 2)
    }
    #[doc = "Bit 4 - Up-Down Mode"]
    #[inline(always)]
    #[must_use]
    pub fn udm(&mut self) -> UdmW<Timbcr2Spec> {
        UdmW::new(self, 4)
    }
    #[doc = "Bits 6:7 - Roll-Over Mode"]
    #[inline(always)]
    #[must_use]
    pub fn rom(&mut self) -> RomW<Timbcr2Spec> {
        RomW::new(self, 6)
    }
    #[doc = "Bits 8:9 - Output Roll-Over Mode"]
    #[inline(always)]
    #[must_use]
    pub fn outrom(&mut self) -> OutromW<Timbcr2Spec> {
        OutromW::new(self, 8)
    }
    #[doc = "Bits 10:11 - ADC Roll-Over Mode"]
    #[inline(always)]
    #[must_use]
    pub fn adrom(&mut self) -> AdromW<Timbcr2Spec> {
        AdromW::new(self, 10)
    }
    #[doc = "Bits 12:13 - Burst Mode Roll-Over Mode"]
    #[inline(always)]
    #[must_use]
    pub fn bmrom(&mut self) -> BmromW<Timbcr2Spec> {
        BmromW::new(self, 12)
    }
    #[doc = "Bits 14:15 - Fault and Event Roll-Over Mode"]
    #[inline(always)]
    #[must_use]
    pub fn ferom(&mut self) -> FeromW<Timbcr2Spec> {
        FeromW::new(self, 14)
    }
    #[doc = "Bit 16 - Greater than Compare 1 PWM mode"]
    #[inline(always)]
    #[must_use]
    pub fn gtcmp1(&mut self) -> Gtcmp1W<Timbcr2Spec> {
        Gtcmp1W::new(self, 16)
    }
    #[doc = "Bit 17 - Greater than Compare 3 PWM mode"]
    #[inline(always)]
    #[must_use]
    pub fn gtcmp3(&mut self) -> Gtcmp3W<Timbcr2Spec> {
        Gtcmp3W::new(self, 17)
    }
    #[doc = "Bit 20 - Triggered-half mode"]
    #[inline(always)]
    #[must_use]
    pub fn trghlf(&mut self) -> TrghlfW<Timbcr2Spec> {
        TrghlfW::new(self, 20)
    }
}
...
pub struct Timbcr2Spec;
impl crate::RegisterSpec for Timbcr2Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`timbcr2::R`](R) reader structure"]
impl crate::Readable for Timbcr2Spec {}
#[doc = "`write(|w| ..)` method takes [`timbcr2::W`](W) writer structure"]
impl crate::Writable for Timbcr2Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets TIMBCR2 to value 0"]
impl crate::Resettable for Timbcr2Spec {
