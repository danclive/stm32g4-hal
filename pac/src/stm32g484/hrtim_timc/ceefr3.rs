...
pub type R = crate::R<Ceefr3Spec>;
#[doc = "Register `CEEFR3` writer"]
pub type W = crate::W<Ceefr3Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn eevace(&mut self) -> EevaceW<Ceefr3Spec> {
        EevaceW::new(self, 0)
    }
    #[doc = "Bit 1 - External Event A Counter Reset"]
    #[inline(always)]
    #[must_use]
    pub fn eevacres(&mut self) -> EevacresW<Ceefr3Spec> {
        EevacresW::new(self, 1)
    }
    #[doc = "Bit 2 - External Event A Reset Mode"]
    #[inline(always)]
    #[must_use]
    pub fn eevarstm(&mut self) -> EevarstmW<Ceefr3Spec> {
        EevarstmW::new(self, 2)
    }
    #[doc = "Bits 4:7 - External Event A Selection"]
    #[inline(always)]
    #[must_use]
    pub fn eevasel(&mut self) -> EevaselW<Ceefr3Spec> {
        EevaselW::new(self, 4)
    }
    #[doc = "Bits 8:13 - External Event A counter"]
    #[inline(always)]
    #[must_use]
    pub fn eevacnt(&mut self) -> EevacntW<Ceefr3Spec> {
        EevacntW::new(self, 8)
    }
}
#[doc = "HRTIM Timerx External Event Filtering Register 3\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ceefr3::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ceefr3::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Ceefr3Spec;
impl crate::RegisterSpec for Ceefr3Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ceefr3::R`](R) reader structure"]
impl crate::Readable for Ceefr3Spec {}
#[doc = "`write(|w| ..)` method takes [`ceefr3::W`](W) writer structure"]
impl crate::Writable for Ceefr3Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets CEEFR3 to value 0"]
impl crate::Resettable for Ceefr3Spec {
