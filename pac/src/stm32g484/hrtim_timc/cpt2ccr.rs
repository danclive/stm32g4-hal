...
pub type Tf1cmp1R = crate::BitReader;
#[doc = "Field `TF1CMP1` writer - TF1CMP1"]
pub type Tf1cmp1W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `TF1CMP2` reader - TF1CMP2"]
pub type Tf1cmp2R = crate::BitReader;
#[doc = "Field `TF1CMP2` writer - TF1CMP2"]
pub type Tf1cmp2W<'a, REG> = crate::BitWriter<'a, REG>;
...
impl R {
    ...
    pub fn tf1set(&self) -> Tf1setR {
        Tf1setR::new(((self.bits >> 20) & 1) != 0)
    }
    #[doc = "Bit 21 - TF1RST"]
    #[inline(always)]
    pub fn tf1rst(&self) -> Tf1rstR {
        Tf1rstR::new(((self.bits >> 21) & 1) != 0)
    }
    #[doc = "Bit 22 - TF1CMP1"]
    #[inline(always)]
    pub fn tf1cmp1(&self) -> Tf1cmp1R {
        Tf1cmp1R::new(((self.bits >> 22) & 1) != 0)
    }
    #[doc = "Bit 23 - TF1CMP2"]
    #[inline(always)]
    pub fn tf1cmp2(&self) -> Tf1cmp2R {
        Tf1cmp2R::new(((self.bits >> 23) & 1) != 0)
    }
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tf1set(&mut self) -> Tf1setW<Cpt2ccrSpec> {
        Tf1setW::new(self, 20)
    }
    #[doc = "Bit 21 - TF1RST"]
    #[inline(always)]
    #[must_use]
    pub fn tf1rst(&mut self) -> Tf1rstW<Cpt2ccrSpec> {
        Tf1rstW::new(self, 21)
    }
    #[doc = "Bit 22 - TF1CMP1"]
    #[inline(always)]
    #[must_use]
    pub fn tf1cmp1(&mut self) -> Tf1cmp1W<Cpt2ccrSpec> {
        Tf1cmp1W::new(self, 22)
    }
    #[doc = "Bit 23 - TF1CMP2"]
    #[inline(always)]
    #[must_use]
    pub fn tf1cmp2(&mut self) -> Tf1cmp2W<Cpt2ccrSpec> {
        Tf1cmp2W::new(self, 23)
    }
    #[doc = "Bit 24 - Timer D output 1 Set"]
    #[inline(always)]
    #[must_use]
