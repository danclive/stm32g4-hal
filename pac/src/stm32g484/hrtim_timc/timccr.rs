...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn intlvd(&mut self) -> IntlvdW<TimccrSpec> {
        IntlvdW::new(self, 7)
    }
    #[doc = "Bit 9 - Re-Synchronized Update"]
    #[inline(always)]
    #[must_use]
    pub fn rsyncu(&mut self) -> RsyncuW<TimccrSpec> {
        RsyncuW::new(self, 9)
    }
    #[doc = "Bit 10 - Synchronization Resets Timer x"]
    #[inline(always)]
    ...
    #[inline(always)]
    #[must_use]
    pub fn tfu(&mut self) -> TfuW<TimccrSpec> {
        TfuW::new(self, 16)
    }
    #[doc = "Bit 17 - Timer x Repetition update"]
    #[inline(always)]
    ...
    #[inline(always)]
    #[must_use]
    pub fn tau(&mut self) -> TauW<TimccrSpec> {
        TauW::new(self, 19)
    }
    #[doc = "Bit 20 - TBU"]
    #[inline(always)]
