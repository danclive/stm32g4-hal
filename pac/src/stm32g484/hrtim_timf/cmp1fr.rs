...
pub type R = crate::R<Cmp1frSpec>;
#[doc = "Register `CMP1FR` writer"]
pub type W = crate::W<Cmp1frSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn cmp1x(&mut self) -> Cmp1xW<Cmp1frSpec> {
        Cmp1xW::new(self, 0)
    }
}
...
pub struct Cmp1frSpec;
impl crate::RegisterSpec for Cmp1frSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`cmp1fr::R`](R) reader structure"]
impl crate::Readable for Cmp1frSpec {}
#[doc = "`write(|w| ..)` method takes [`cmp1fr::W`](W) writer structure"]
impl crate::Writable for Cmp1frSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets CMP1FR to value 0"]
impl crate::Resettable for Cmp1frSpec {
