...
pub type R = crate::R<Feefr3Spec>;
#[doc = "Register `FEEFR3` writer"]
pub type W = crate::W<Feefr3Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn eevace(&mut self) -> EevaceW<Feefr3Spec> {
        EevaceW::new(self, 0)
    }
    #[doc = "Bit 1 - External Event A Counter Reset"]
    #[inline(always)]
    #[must_use]
    pub fn eevacres(&mut self) -> EevacresW<Feefr3Spec> {
        EevacresW::new(self, 1)
    }
    #[doc = "Bit 2 - External Event A Reset Mode"]
    #[inline(always)]
    #[must_use]
    pub fn eevarstm(&mut self) -> EevarstmW<Feefr3Spec> {
        EevarstmW::new(self, 2)
    }
    #[doc = "Bits 4:7 - External Event A Selection"]
    #[inline(always)]
    #[must_use]
    pub fn eevasel(&mut self) -> EevaselW<Feefr3Spec> {
        EevaselW::new(self, 4)
    }
    #[doc = "Bits 8:13 - External Event A counter"]
    #[inline(always)]
    #[must_use]
    pub fn eevacnt(&mut self) -> EevacntW<Feefr3Spec> {
        EevacntW::new(self, 8)
    }
}
...
pub struct Feefr3Spec;
impl crate::RegisterSpec for Feefr3Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`feefr3::R`](R) reader structure"]
impl crate::Readable for Feefr3Spec {}
#[doc = "`write(|w| ..)` method takes [`feefr3::W`](W) writer structure"]
impl crate::Writable for Feefr3Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets FEEFR3 to value 0"]
impl crate::Resettable for Feefr3Spec {
