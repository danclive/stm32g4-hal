...
pub type R = crate::R<PerfrSpec>;
#[doc = "Register `PERFR` writer"]
pub type W = crate::W<PerfrSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn perx(&mut self) -> PerxW<PerfrSpec> {
        PerxW::new(self, 0)
    }
}
