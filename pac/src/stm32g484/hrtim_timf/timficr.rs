...
pub type W = crate::W<TimficrSpec>;
...
impl core::fmt::Debug for crate::generic::Reg<TimficrSpec> {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn cmp1c(&mut self) -> Cmp1cW<TimficrSpec> {
        Cmp1cW::new(self, 0)
    }
    #[doc = "Bit 1 - Compare 2 Interrupt flag Clear"]
    #[inline(always)]
    #[must_use]
    pub fn cmp2c(&mut self) -> Cmp2cW<TimficrSpec> {
        Cmp2cW::new(self, 1)
    }
    #[doc = "Bit 2 - Compare 3 Interrupt flag Clear"]
    #[inline(always)]
    #[must_use]
    pub fn cmp3c(&mut self) -> Cmp3cW<TimficrSpec> {
        Cmp3cW::new(self, 2)
    }
    #[doc = "Bit 3 - Compare 4 Interrupt flag Clear"]
    #[inline(always)]
    #[must_use]
    pub fn cmp4c(&mut self) -> Cmp4cW<TimficrSpec> {
        Cmp4cW::new(self, 3)
    }
    #[doc = "Bit 4 - Repetition Interrupt flag Clear"]
    #[inline(always)]
    #[must_use]
    pub fn repc(&mut self) -> RepcW<TimficrSpec> {
        RepcW::new(self, 4)
    }
    #[doc = "Bit 6 - Update Interrupt flag Clear"]
    #[inline(always)]
    #[must_use]
    pub fn updc(&mut self) -> UpdcW<TimficrSpec> {
        UpdcW::new(self, 6)
    }
    #[doc = "Bit 7 - Capture1 Interrupt flag Clear"]
    #[inline(always)]
    #[must_use]
    pub fn cpt1c(&mut self) -> Cpt1cW<TimficrSpec> {
        Cpt1cW::new(self, 7)
    }
    #[doc = "Bit 8 - Capture2 Interrupt flag Clear"]
    #[inline(always)]
    #[must_use]
    pub fn cpt2c(&mut self) -> Cpt2cW<TimficrSpec> {
        Cpt2cW::new(self, 8)
    }
    #[doc = "Bit 9 - Output 1 Set flag Clear"]
    #[inline(always)]
    #[must_use]
    pub fn set1x_c(&mut self) -> Set1xCW<TimficrSpec> {
        Set1xCW::new(self, 9)
    }
    #[doc = "Bit 10 - Output 1 Reset flag Clear"]
    #[inline(always)]
    #[must_use]
    pub fn rstx1c(&mut self) -> Rstx1cW<TimficrSpec> {
        Rstx1cW::new(self, 10)
    }
    #[doc = "Bit 11 - Output 2 Set flag Clear"]
    #[inline(always)]
    #[must_use]
    pub fn set2x_c(&mut self) -> Set2xCW<TimficrSpec> {
        Set2xCW::new(self, 11)
    }
    #[doc = "Bit 12 - Output 2 Reset flag Clear"]
    #[inline(always)]
    #[must_use]
    pub fn rstx2c(&mut self) -> Rstx2cW<TimficrSpec> {
        Rstx2cW::new(self, 12)
    }
    #[doc = "Bit 13 - Reset Interrupt flag Clear"]
    #[inline(always)]
    #[must_use]
    pub fn rstc(&mut self) -> RstcW<TimficrSpec> {
        RstcW::new(self, 13)
    }
    #[doc = "Bit 14 - Delayed Protection Flag Clear"]
    #[inline(always)]
    #[must_use]
    pub fn dlyprtc(&mut self) -> DlyprtcW<TimficrSpec> {
...
pub struct TimficrSpec;
impl crate::RegisterSpec for TimficrSpec {
    type Ux = u32;
}
#[doc = "`write(|w| ..)` method takes [`timficr::W`](W) writer structure"]
impl crate::Writable for TimficrSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets TIMFICR to value 0"]
impl crate::Resettable for TimficrSpec {
