#![doc = "Peripheral access API for STM32G484 microcontrollers (generated using svd2rust v0.33.3 ( ))\n\nYou can find an overview of the generated API [here].\n\nAPI features to be included in the [next]
...
pub struct HrtimMaster {
    _marker: PhantomData<*const ()>,
}
unsafe impl Send for HrtimMaster {}
impl HrtimMaster {
    #[doc = r"Pointer to the register block"]
...
pub struct HrtimTima {
    _marker: PhantomData<*const ()>,
}
unsafe impl Send for HrtimTima {}
impl HrtimTima {
    #[doc = r"Pointer to the register block"]
...
pub struct HrtimTimb {
    _marker: PhantomData<*const ()>,
}
unsafe impl Send for HrtimTimb {}
impl HrtimTimb {
    #[doc = r"Pointer to the register block"]
...
pub struct HrtimTimc {
    _marker: PhantomData<*const ()>,
}
unsafe impl Send for HrtimTimc {}
impl HrtimTimc {
    #[doc = r"Pointer to the register block"]
...
pub struct HrtimTimd {
    _marker: PhantomData<*const ()>,
}
unsafe impl Send for HrtimTimd {}
impl HrtimTimd {
    #[doc = r"Pointer to the register block"]
...
pub struct HrtimTime {
    _marker: PhantomData<*const ()>,
}
unsafe impl Send for HrtimTime {}
impl HrtimTime {
    #[doc = r"Pointer to the register block"]
...
pub struct HrtimTimf {
    _marker: PhantomData<*const ()>,
}
unsafe impl Send for HrtimTimf {}
impl HrtimTimf {
    #[doc = r"Pointer to the register block"]
...
impl core::fmt::Debug for HrtimTimf {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("HrtimTimf").finish()
    }
}
#[doc = "High Resolution Timer: TIMF"]
pub mod hrtim_timf;
#[doc = "High Resolution Timer: Common functions"]
pub struct HrtimCommon {
    _marker: PhantomData<*const ()>,
}
unsafe impl Send for HrtimCommon {}
impl HrtimCommon {
    #[doc = r"Pointer to the register block"]
...
impl Peripherals {
    ...
    pub unsafe fn steal() -> Self {
        ...
        Peripherals {
            ...
            hrtim_master: HrtimMaster {
                _marker: PhantomData,
            },
            hrtim_tima: HrtimTima {
                _marker: PhantomData,
            },
            hrtim_timb: HrtimTimb {
                _marker: PhantomData,
            },
            hrtim_timc: HrtimTimc {
                _marker: PhantomData,
            },
            hrtim_timd: HrtimTimd {
                _marker: PhantomData,
            },
            hrtim_time: HrtimTime {
                _marker: PhantomData,
            },
            hrtim_timf: HrtimTimf {
                _marker: PhantomData,
            },
            hrtim_common: HrtimCommon {
                _marker: PhantomData,
            },
            quadspi: Quadspi {
                _marker: PhantomData,
