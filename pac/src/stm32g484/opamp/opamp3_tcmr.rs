...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn vms_sel(&mut self) -> VmsSelW<Opamp3TcmrSpec> {
        VmsSelW::new(self, 0)
    }
    #[doc = "Bits 1:2 - VPS_SEL"]
    #[inline(always)]
    #[must_use]
    pub fn vps_sel(&mut self) -> VpsSelW<Opamp3TcmrSpec> {
        VpsSelW::new(self, 1)
    }
    #[doc = "Bit 3 - T1CM_EN"]
    #[inline(always)]
    #[must_use]
    pub fn t1cm_en(&mut self) -> T1cmEnW<Opamp3TcmrSpec> {
        T1cmEnW::new(self, 3)
    }
    #[doc = "Bit 4 - T8CM_EN"]
    #[inline(always)]
    #[must_use]
    pub fn t8cm_en(&mut self) -> T8cmEnW<Opamp3TcmrSpec> {
        T8cmEnW::new(self, 4)
    }
    #[doc = "Bit 5 - T20CM_EN"]
    #[inline(always)]
    #[must_use]
    pub fn t20cm_en(&mut self) -> T20cmEnW<Opamp3TcmrSpec> {
        T20cmEnW::new(self, 5)
    }
    #[doc = "Bit 31 - LOCK"]
    #[inline(always)]
    #[must_use]
    pub fn lock(&mut self) -> LockW<Opamp3TcmrSpec> {
        LockW::new(self, 31)
    }
}
#[doc = "OPAMP3 control/status register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`opamp3_tcmr::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`opamp3_tcmr::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
