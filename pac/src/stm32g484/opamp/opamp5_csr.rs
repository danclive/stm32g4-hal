...
pub type R = crate::R<Opamp5CsrSpec>;
#[doc = "Register `OPAMP5_CSR` writer"]
pub type W = crate::W<Opamp5CsrSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn opaen(&mut self) -> OpaenW<Opamp5CsrSpec> {
        OpaenW::new(self, 0)
    }
    #[doc = "Bit 1 - FORCE_VP"]
    #[inline(always)]
    #[must_use]
    pub fn force_vp(&mut self) -> ForceVpW<Opamp5CsrSpec> {
        ForceVpW::new(self, 1)
    }
    #[doc = "Bits 2:3 - VP_SEL"]
    #[inline(always)]
    #[must_use]
    pub fn vp_sel(&mut self) -> VpSelW<Opamp5CsrSpec> {
        VpSelW::new(self, 2)
    }
    #[doc = "Bit 4 - USERTRIM"]
    #[inline(always)]
    #[must_use]
    pub fn usertrim(&mut self) -> UsertrimW<Opamp5CsrSpec> {
        UsertrimW::new(self, 4)
    }
    #[doc = "Bits 5:6 - VM_SEL"]
    #[inline(always)]
    #[must_use]
    pub fn vm_sel(&mut self) -> VmSelW<Opamp5CsrSpec> {
        VmSelW::new(self, 5)
    }
    #[doc = "Bit 7 - OPAHSM"]
    #[inline(always)]
    #[must_use]
    pub fn opahsm(&mut self) -> OpahsmW<Opamp5CsrSpec> {
        OpahsmW::new(self, 7)
    }
    #[doc = "Bit 8 - OPAINTOEN"]
    #[inline(always)]
    #[must_use]
    pub fn opaintoen(&mut self) -> OpaintoenW<Opamp5CsrSpec> {
        OpaintoenW::new(self, 8)
    }
    #[doc = "Bit 11 - CALON"]
    #[inline(always)]
    #[must_use]
    pub fn calon(&mut self) -> CalonW<Opamp5CsrSpec> {
        CalonW::new(self, 11)
    }
    #[doc = "Bits 12:13 - CALSEL"]
    #[inline(always)]
    #[must_use]
    pub fn calsel(&mut self) -> CalselW<Opamp5CsrSpec> {
        CalselW::new(self, 12)
    }
    #[doc = "Bits 14:18 - PGA_GAIN"]
    #[inline(always)]
    #[must_use]
    pub fn pga_gain(&mut self) -> PgaGainW<Opamp5CsrSpec> {
        PgaGainW::new(self, 14)
    }
    #[doc = "Bits 19:23 - TRIMOFFSETP"]
    #[inline(always)]
    #[must_use]
    pub fn trimoffsetp(&mut self) -> TrimoffsetpW<Opamp5CsrSpec> {
        TrimoffsetpW::new(self, 19)
    }
    #[doc = "Bits 24:28 - TRIMOFFSETN"]
    #[inline(always)]
    #[must_use]
    pub fn trimoffsetn(&mut self) -> TrimoffsetnW<Opamp5CsrSpec> {
        TrimoffsetnW::new(self, 24)
    }
    #[doc = "Bit 30 - CALOUT"]
    #[inline(always)]
    #[must_use]
    pub fn calout(&mut self) -> CaloutW<Opamp5CsrSpec> {
        CaloutW::new(self, 30)
    }
    #[doc = "Bit 31 - LOCK"]
    #[inline(always)]
    #[must_use]
    pub fn lock(&mut self) -> LockW<Opamp5CsrSpec> {
        LockW::new(self, 31)
    }
}
#[doc = "OPAMP5 control/status register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`opamp5_csr::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`opamp5_csr::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Opamp5CsrSpec;
impl crate::RegisterSpec for Opamp5CsrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`opamp5_csr::R`](R) reader structure"]
impl crate::Readable for Opamp5CsrSpec {}
#[doc = "`write(|w| ..)` method takes [`opamp5_csr::W`](W) writer structure"]
impl crate::Writable for Opamp5CsrSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets OPAMP5_CSR to value 0"]
impl crate::Resettable for Opamp5CsrSpec {
